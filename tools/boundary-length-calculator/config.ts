export const boundaryLengthCalculatorConfig = {
  ...
  seo: {
    ...
    description: "Calculate total boundary length or perimeter instantly for plots, land, rooms, or property boundaries. Fast, accurate, and free online calculator.",
    keywords: [
