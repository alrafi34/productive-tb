    ...
    <>
      <div className="max-w-7xl mx-auto p-6 space-y-8">
        ...
        <div className="text-center space-y-4">
          <h1 className="text-4xl font-bold text-gray-900">Gradient Text Generator</h1>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6">
              ...
              <div 
                className="min-h-32 flex items-center justify-center p-8 rounded-lg"
                ...
                <div className="flex gap-2">
                  {['#ffffff', '#000000', '#f3f4f6', '#1f2937'].map((bg) => (
                    <button
                      ...
                      className={`w-8 h-8 rounded border-2 ${background === bg ? 'border-primary' : 'border-gray-300'}`}
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="text-sm font-medium text-gray-700">Font Size: {text.fontSize}px</label>
                  <input
                    type="range"
                    min="16"
                    max="150"
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6">
              ...
              {gradient.type === 'linear' && (
                <div className="mt-4">
                  <label className="text-sm font-medium text-gray-700">Angle: {gradient.angle}°</label>
                  <input
                    type="range"
                    min="0"
                    max="360"
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <button
                  ...
                  className="flex items-center gap-1 px-2 py-1 text-sm bg-primary text-white rounded hover:bg-primary/90"
                >
