export const toolConfig = {
  slug: "social-media-post-preview",
  name: "Social Media Post Preview",
  description: "See how your text looks as a Twitter/X post, LinkedIn update, or Instagram caption before publishing.",
  icon: "📱",
  category: "creator",
  seo: {
    ...
    openGraph: {
      title: "Social Media Post Preview Tool",
      description: "Preview posts on Twitter/X, LinkedIn, and Instagram with real-time character counting and formatting.",
    },
  },
};
