...
export const electricalEfficiencyCalculatorConfig = {
  ...
  seo: {
    title: "Electrical Efficiency Calculator – Calculate Power System Efficiency Online | Free Tool",
    description: "Use this free electrical efficiency calculator to compute system efficiency instantly. Enter input and output power to get real-time efficiency percentage for motors, solar systems, and electrical devices.",
    keywords: [
