...
export const adcResolutionCalculatorConfig = {
  ...
  seo: {
    title: "ADC Resolution Calculator – Calculate Step Size & Quantization Levels | Free Tool",
    description: "Free online ADC resolution calculator. Calculate step size, quantization levels, and digital output values with real-time results. Perfect for Arduino, ESP32, and embedded systems.",
    keywords: [
      "ADC calculator",
