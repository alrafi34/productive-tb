export const toolConfig = {
  ...
  slug: "pixel-art-grid",
  description: "Color a 16×16 or 32×32 pixel grid to create retro pixel art. Export as PNG or CSS grid code.",
  category: "creator",
  icon: "🎮",
  seo: {
    ...
    openGraph: {
      title: "Free Pixel Art Creator – Draw Retro Pixel Art Online",
      description: "Create retro pixel art online using a 16×16 or 32×32 grid. Draw pixel graphics, export as PNG, or generate CSS grid code instantly.",
    },
  },
};