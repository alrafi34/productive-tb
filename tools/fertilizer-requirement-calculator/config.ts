...
export const fertilizerRequirementCalculatorConfig = {
  ...
  seo: {
    ...
    description: "Calculate fertilizer requirements instantly for crops based on land size, crop type, and nutrient needs. Estimate Urea, DAP, NPK, and more online for free.",
    keywords: [
