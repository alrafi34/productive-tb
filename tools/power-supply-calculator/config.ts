...
export const powerSupplyCalculatorConfig = {
  ...
  seo: {
    title: "Power Supply Calculator – Find Recommended PSU Wattage for PC Builds | Free Tool",
    description: "Calculate your PC power supply requirements instantly. Enter CPU, GPU, RAM, and components to get accurate PSU wattage recommendations for gaming and workstation builds.",
    keywords: [
      "PSU calculator",
