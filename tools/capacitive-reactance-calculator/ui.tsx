...
export default function CapacitiveReactanceCalculatorUI() {
  ...
  const debouncedCalculate = useCallback(
    ...
    [frequency, frequencyUnit, capacitance, capacitanceUnit]
  );

  // Calculate in real-time
  useEffect(() => {
    debouncedCalculate();
  }, [frequency, frequencyUnit, capacitance, capacitanceUnit, debouncedCalculate]);
  ...
  const calculate = () => {
    ...
    try {
      const calcResult = calculateCapacitiveReactance(input);
  ...
  const handleExportText = () => {
    if (result) {
      ...
      downloadFile(text, 'capacitive_reactance_calculation.txt');
    }
  };
      ...
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="font-semibold text-blue-900 mb-1">Capacitive Reactance Calculator</h3>
              <p className="text-sm text-blue-800">
                Calculate capacitive reactance (XC) using the formula XC = 1/(2πfC). Get instant results with step-by-step explanations.
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="bg-primary rounded-xl border border-primary-light shadow-lg shadow-primary/20 p-6 text-white space-y-4">
                ...
                <div className="mt-4 pt-4 border-t border-white/20 text-sm">
                  <div className="space-y-1">
                    ...
                    <div className="flex justify-between">
                      <span className="text-primary-100">Capacitance:</span>
                      <span className="font-semibold">{formatNumber(result.capacitance)} F</span>
                    </div>
                  </div>
                </div>
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-4">
              <p className="text-sm text-yellow-800">
                <strong>Note:</strong> Capacitive reactance (XC) decreases as frequency increases. 
                At DC (0 Hz), a capacitor acts as an open circuit. At very high frequencies, 
                it acts as a short circuit. This calculator uses the formula XC = 1/(2πfC).
              </p>
            </div>
