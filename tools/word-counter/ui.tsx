    ...
    <div className="max-w-3xl mx-auto">
      <div className="relative mb-6">
        <textarea
          ...
          rows={10}
          className="w-full rounded-xl border border-gray-200 bg-white px-5 py-4 text-sm text-gray-800 placeholder:text-gray-400 shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 resize-y leading-relaxed"
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mb-6">
        {stats.map(({ label, value, icon }) => (
          <div key={label} className="bg-white rounded-xl border border-gray-100 shadow-sm p-4 flex flex-col gap-1">
            ...
            <span className="text-2xl font-bold text-indigo-600" style={{ fontFamily: "var(--font-heading)" }}>{value}</span>
