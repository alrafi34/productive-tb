export const landValuationCalculatorConfig = {
  ...
  seo: {
    ...
    description: "Calculate land value instantly using area size, unit price, and extra costs. Supports Katha, Acre, Decimal, Sq Ft, and more. Fast, free, and easy property valuation calculator.",
    keywords: [
