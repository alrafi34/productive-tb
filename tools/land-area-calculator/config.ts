...
export const landAreaCalculatorConfig = {
  ...
  seo: {
    ...
    description: "Calculate land area in square feet instantly from length and width. Free online land area calculator with feet, meter, and yard conversion support.",
    keywords: [
