...
export default function UtilizationGauge({ pct, color, label = "utilization", size = 160 }: Props) {
  ...
  return <canvas ref={canvasRef} role="img" aria-label={`${label} ${pct.toFixed(0)} percent`} />;
}
