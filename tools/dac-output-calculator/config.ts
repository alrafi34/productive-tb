export const dacOutputCalculatorConfig = {
  ...
  seo: {
    title: "DAC Output Calculator – Convert Digital Value to Analog Voltage | Free Tool",
    description: "Free online DAC output calculator. Calculate analog voltage from digital input with real-time results. Perfect for Arduino, ESP32, audio DAC, and embedded systems.",
    keywords: [
      "DAC calculator",
