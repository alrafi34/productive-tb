export const earthFillingCalculatorConfig = {
  ...
  seo: {
    ...
    description: "Calculate earth fill material required for construction, land filling, ponds, foundations, and excavation projects. Estimate cubic feet, cubic meters, truckloads, and cost instantly.",
    keywords: [
