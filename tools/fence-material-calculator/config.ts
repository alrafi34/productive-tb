...
export const fenceMaterialCalculatorConfig = {
  ...
  seo: {
    ...
    description: "Calculate fence materials instantly. Estimate fence panels, posts, concrete, spacing, and perimeter for wood, vinyl, chain link, and metal fencing.",
    keywords: [
