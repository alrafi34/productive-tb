...
export const decimalToBinaryCalculatorConfig = {
  ...
  seo: {
    title: "Decimal to Binary Calculator – Convert Decimal to Binary Instantly | Free Tool",
    description: "Free online decimal to binary calculator. Convert decimal numbers to binary with step-by-step explanation. Fast, accurate, and educational.",
    keywords: [
      ...
      "binary encoder",
      "decimal binary converter online"
    ],
    og: {
