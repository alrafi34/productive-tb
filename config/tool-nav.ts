...
/* Shown under "Popular tools" in the side rail: these three on every page… */
...
/* …then four from this pool of everyday tools, chosen per page (stable for a
   given tool), so each is linked from dozens of pages rather than a few (#70). */
export const POPULAR_POOL: readonly string[] = [
  "bmi-calculator",
  "age-calculator",
  "password-generator",
  "qr-code-generator",
