...
export const tools: Tool[] = [
  ...
  { slug: "unit-converter", name: "Unit Converter", description: "Convert metric and imperial units.", category: "calculator", icon: "📊", free: true },
  ...
  { slug: "binary-hex-decimal-converter", name: "Binary/Hex/Decimal Converter", description: "Switch numbers between different bases.", category: "calculator", icon: "🔢", free: true },
  ...
  { slug: "random-number-generator", name: "Random Number Generator", description: "Generate random value within range.", category: "calculator", icon: "🎲", free: true },
  ...
  { slug: "stopwatch-countdown-timer", name: "Stopwatch/Countdown Timer", description: "High-precision timer tool.", category: "calculator", icon: "⏱️", free: true },
  ...
  { slug: "tip-calculator", name: "Tip Calculator", description: "Split bill and calculate tip percentage.", category: "calculator", icon: "💵", free: true },
  { slug: "seconds-to-time-converter", name: "Seconds to HH:MM:SS", description: "Convert large numbers into readable time.", category: "calculator", icon: "⏲️", free: true },
  { slug: "prime-number-checker", name: "Prime Number Checker", description: "Instantly check if number is prime.", category: "calculator", icon: "🔢", free: true },
  { slug: "fibonacci-sequence-generator", name: "Fibonacci Sequence Generator", description: "List sequence up to N numbers.", category: "calculator", icon: "🌀", free: true },
  ...
  { slug: "stopwatch-with-laps", name: "Stopwatch with Laps", description: "Sports-style timer with lap-recording list.", category: "calculator", icon: "⏱️", free: true },
  ...
  { slug: "number-to-words", name: "Number-to-Words", description: "Convert 1,250 to written form.", category: "calculator", icon: "🔢", free: true },
  { slug: "frequency-distribution", name: "Frequency Distribution", description: "Calculate number occurrences in dataset.", category: "calculator", icon: "📊", free: true },
  { slug: "correlation-coefficient-calculator", name: "Correlation Coefficient Calculator", description: "Find relationship between two number sets.", category: "calculator", icon: "📊", free: true },
  ...
  { slug: "time-difference-seconds", name: "Time Difference (Seconds)", description: "Find gap between two timestamps.", category: "calculator", icon: "⏱️", free: true },
  ...
  { slug: "aspect-ratio-grid", name: "Aspect Ratio Grid", description: "See grid of all standard ratios.", category: "calculator", icon: "📐", free: true },
  { slug: "binary-subnet-calculator", name: "Binary Subnet Calculator", description: "Calculate IP ranges and CIDR notation.", category: "calculator", icon: "🌐", free: true },
  { slug: "compound-interest-grapher", name: "Compound Interest Grapher", description: "Chart showing savings growth over years.", category: "calculator", icon: "📈", free: true },
  { slug: "inflation-calculator", name: "Inflation Calculator", description: "Show value of $1 across decades.", category: "calculator", icon: "💵", free: true },
  { slug: "statistical-mode-median-mean", name: "Statistical Mode/Median/Mean", description: "Quick statistical analysis tool.", category: "calculator", icon: "📊", free: true },
  { slug: "truth-table-generator", name: "Truth Table Generator", description: "Enter logic gate and see resulting table.", category: "calculator", icon: "🔢", free: true },
  { slug: "gpa-calculator", name: "Grade Point Average (GPA) Calculator", description: "Calculate semester GPA.", category: "calculator", icon: "🎓", free: true },
  { slug: "time-to-decimal-converter", name: "Time-to-Decimal Converter", description: "Turn 1 hour 30 mins into 1.5 hours.", category: "calculator", icon: "⏰", free: true },
  ...
  { slug: "scientific-notation-converter", name: "Scientific Notation Converter", description: "Switch between standard and E notation.", category: "calculator", icon: "🔬", free: true },
  ...
  { slug: "number-to-currency-converter", name: "Number-to-Currency Converter", description: "Format numbers into locale currency strings.", category: "calculator", icon: "💵", free: true },
  ...
  { slug: "unit-converter-scientific", name: "Unit Converter (Scientific)", description: "Handle scientific units like Joules to Calories.", category: "calculator", icon: "🔬", free: true },
  ...
  { slug: "polynomial-solver", name: "Polynomial Solver", description: "Finds roots for ax² + bx + c = 0.", category: "calculator", icon: "📐", free: true },
  { slug: "unit-converter-advanced", name: "Unit Converter (Advanced)", description: "Includes planetary, astronomical, and subatomic units.", category: "calculator", icon: "🌌", free: true },
  { slug: "linear-regression-tool", name: "Linear Regression Tool", description: "Plots coordinates and finds the line of best fit.", category: "calculator", icon: "📈", free: true },
  { slug: "fibonacci-sequence-plotter", name: "Fibonacci Sequence Plotter", description: "Draws the golden spiral on a canvas.", category: "calculator", icon: "🌀", free: true },
  { slug: "standard-deviation-calculator-dataset", name: "Standard Deviation Calculator (Data Set)", description: "Handles large inputs via CSV.", category: "calculator", icon: "📊", free: true },
  { slug: "vector-calculator", name: "Vector Calculator", description: "Performs dot and cross products.", category: "calculator", icon: "➡️", free: true },
  { slug: "complex-number-operations", name: "Complex Number Operations", description: "Handles a + bi math.", category: "calculator", icon: "🔢", free: true },
  { slug: "logarithmic-scale-tool", name: "Logarithmic Scale Tool", description: "Plots values on a logarithmic axis.", category: "calculator", icon: "📊", free: true },
  { slug: "trigonometric-function-plotter", name: "Trigonometric Function Plotter", description: "Draws sin(x), cos(x), etc.", category: "calculator", icon: "📐", free: true },
  { slug: "base-conversion-arbitrary", name: "Base Conversion (Arbitrary)", description: "Handles custom bases from 2 to 36.", category: "calculator", icon: "🔢", free: true },
  { slug: "probability-simulator", name: "Probability Simulator", description: "Simulates large-scale coin flips or card draws.", category: "calculator", icon: "🎲", free: true },
  ...
  { slug: "distance-formula-calculator", name: "Distance Formula Calculator", description: "Computes distance between two coordinates in 3D.", category: "calculator", icon: "📏", free: true },
  { slug: "mean-median-mode-finder", name: "Mean/Median/Mode Finder", description: "Displays all three stats simultaneously.", category: "calculator", icon: "📊", free: true },
  { slug: "prime-factorization-tool", name: "Prime Factorization Tool", description: "Breaks down large integers into primes.", category: "calculator", icon: "🔢", free: true },
  { slug: "factorial-calculator", name: "Factorial Calculator", description: "Handles large numbers (e.g., 100!).", category: "calculator", icon: "❗", free: true },
  { slug: "slope-intercept-calculator", name: "Slope Intercept Calculator", description: "From two points, derives y = mx + b.", category: "calculator", icon: "📐", free: true },
  { slug: "geometric-shape-calculator", name: "Geometric Shape Area/Volume", description: "Calculators for sphere, pyramid, prism, etc.", category: "calculator", icon: "🔷", free: true },
  { slug: "percentage-change-over-time", name: "Percentage Change over Time", description: "Calculates compounding interest.", category: "calculator", icon: "📈", free: true },
  { slug: "fraction-simplified-calculator", name: "Fraction Simplified Calculator", description: "Reduces x/y to simplest form.", category: "calculator", icon: "➗", free: true },
  { slug: "scientific-notation-formatter", name: "Scientific Notation Formatter", description: "Adjusts E notation for papers.", category: "calculator", icon: "🔬", free: true },
  { slug: "statistical-zscore-calculator", name: "Statistical Z-Score Calculator", description: "Calculates standard scores.", category: "calculator", icon: "📊", free: true },
  { slug: "chi-square-test-tool", name: "Chi-Square Test Tool", description: "Analyzes categorical data.", category: "calculator", icon: "📊", free: true },
  { slug: "equation-balancer-chemistry", name: "Equation Balancer (Chemistry)", description: "Balances simple chemical reactions.", category: "calculator", icon: "⚗️", free: true },
  { slug: "periodic-table-lookup", name: "Periodic Table Lookup", description: "Displays data for all chemical elements.", category: "calculator", icon: "🧪", free: true },
  { slug: "mole-calculator", name: "Mole Calculator", description: "Converts grams to moles for any element.", category: "calculator", icon: "⚗️", free: true },
  { slug: "physics-formula-playground", name: "Physics Formula Playground", description: "Interactive tool for F = ma or E = mc².", category: "calculator", icon: "⚛️", free: true },
  { slug: "energy-conversion", name: "Energy Conversion", description: "Joules, BTUs, Calories, Watt-hours.", category: "calculator", icon: "⚡", free: true },
  ...
  { slug: "projectile-motion-simulator", name: "Projectile Motion Simulator", description: "Plots trajectories of launched objects.", category: "calculator", icon: "🎯", free: true },
  { slug: "optics-lens-calculator", name: "Optics/Lens Calculator", description: "Uses the thin lens equation.", category: "calculator", icon: "🔍", free: true },
  { slug: "binary-logic-gate-simulator", name: "Binary Logic Gate Simulator", description: "A visual canvas for AND/OR/XOR gates.", category: "calculator", icon: "🔌", free: true },
  { slug: "base64-to-hex", name: "Base64-to-Hex", description: "Low-level memory data conversion.", category: "developer", icon: "🔢", free: true },
  { slug: "data-entropy-calculator", name: "Data Entropy Calculator", description: "Measures randomness of a byte sequence.", category: "calculator", icon: "📊", free: true },
  ...
  { slug: "periodic-table-searchable", name: "Periodic Table of Elements (Searchable)", description: "Deep data view (atomic weight, electron config).", category: "calculator", icon: "🧪", free: true },
  ...
  { slug: "matrix-multiplication-step-by-step", name: "Matrix Multiplication (Step-by-Step)", description: "Displays the intermediate math.", category: "calculator", icon: "🔢", free: true },
  { slug: "polynomial-roots-solver-numerical", name: "Polynomial Roots Solver (Numerical)", description: "Uses Newton-Raphson method.", category: "calculator", icon: "📐", free: true },
  { slug: "unit-conversion-relativistic", name: "Unit Conversion (Relativistic)", description: "Handles non-Newtonian physics units.", category: "calculator", icon: "🌌", free: true },
  { slug: "linear-regression-data-entry", name: "Linear Regression (Data Entry)", description: "Dynamic graph plotting for coordinate lists.", category: "calculator", icon: "📈", free: true },
  { slug: "fibonacci-spiral-canvas", name: "Fibonacci Spiral Canvas", description: "Draws the visual golden ratio rectangle.", category: "calculator", icon: "🌀", free: true },
  { slug: "standard-deviation-population-sample", name: "Standard Deviation (Population vs. Sample)", description: "Toggle between the two formulas.", category: "calculator", icon: "📊", free: true },
  { slug: "vector-dot-product-visualizer", name: "Vector Dot Product Visualizer", description: "Displays the angle between vectors.", category: "calculator", icon: "➡️", free: true },
  { slug: "complex-plane-grapher", name: "Complex Plane Grapher", description: "Visualizes real/imaginary values on a 2D plane.", category: "calculator", icon: "📊", free: true },
  { slug: "logarithmic-graph-scale-generator", name: "Logarithmic Graph Scale Generator", description: "Allows data to be plotted on a log scale.", category: "calculator", icon: "📈", free: true },
  { slug: "trigonometric-graph-interactive", name: "Trigonometric Graph (Interactive)", description: "Move amplitude/frequency sliders.", category: "calculator", icon: "📐", free: true },
  { slug: "arbitrary-base-converter-2-64", name: "Arbitrary Base Converter (Base 2-64)", description: "Handles huge number conversion.", category: "calculator", icon: "🔢", free: true },
  { slug: "probability-poisson-normal-calculator", name: "Probability (Poisson/Normal Distribution) Calculator", description: "Visual bell curve.", category: "calculator", icon: "📊", free: true },
  { slug: "kelvin-to-rankine-conversion", name: "Kelvin to Rankine Conversion", description: "Highly specific thermodynamic unit swaps.", category: "calculator", icon: "🌡️", free: true },
  { slug: "3d-distance-formula", name: "3D Distance Formula", description: "Calculates distance in XYZ space.", category: "calculator", icon: "📏", free: true },
  { slug: "mean-median-mode-statistics-dashboard", name: "Mean/Median/Mode Statistics Dashboard", description: "Summary stats for CSV uploads.", category: "calculator", icon: "📊", free: true },
  { slug: "prime-factorization-tree-view", name: "Prime Factorization (Tree view)", description: "Visually breaks down large integers.", category: "calculator", icon: "🌳", free: true },
  { slug: "factorial-calculator-high-precision", name: "Factorial Calculator (High Precision)", description: "Handles very large numbers (>1000!).", category: "calculator", icon: "❗", free: true },
  { slug: "slope-intercept-interactive-line", name: "Slope-Intercept (Interactive Line Generator)", description: "Drag points to update the equation.", category: "calculator", icon: "📐", free: true },
  { slug: "geometric-shape-volume-visualizer", name: "Geometric Shape Volume Visualizer", description: "3D model placeholder for spheres/prisms.", category: "calculator", icon: "🔷", free: true },
  { slug: "compound-interest-graph-interactive", name: "Compound Interest Graph (Interactive)", description: "Slider-based growth simulation.", category: "calculator", icon: "📈", free: true },
  { slug: "fraction-to-decimal-high-precision", name: "Fraction-to-Decimal Converter (High precision)", description: "Handles repeating decimals.", category: "calculator", icon: "➗", free: true },
  { slug: "scientific-notation-formatter-ieee754", name: "Scientific Notation Formatter (IEEE 754)", description: "Shows how the computer sees the number.", category: "calculator", icon: "🔬", free: true },
  { slug: "zscore-probability-lookup", name: "Z-Score Probability Lookup", description: "Finds the area under the normal curve.", category: "calculator", icon: "📊", free: true },
  { slug: "chi-square-goodness-of-fit", name: "Chi-Square Test (Goodness of Fit)", description: "Statistical table builder.", category: "calculator", icon: "📊", free: true },
  { slug: "stoichiometry-calculator", name: "Chemistry: Stoichiometry Calculator", description: "Balances complex reactions.", category: "calculator", icon: "⚗️", free: true },
  { slug: "periodic-table-orbital-shell-view", name: "Periodic Table: Orbital Electron Shell View", description: "Visual diagram of shells.", category: "calculator", icon: "🧪", free: true },
  { slug: "mole-mass-volume-relationship", name: "Mole/Mass/Volume Relationship Tool", description: "For chemical gas laws.", category: "calculator", icon: "⚗️", free: true },
  { slug: "hookes-law-simulation", name: "Physics: Hooke's Law Simulation", description: "Springs and force sliders.", category: "calculator", icon: "🔧", free: true },
  { slug: "energy-unit-conversions-atomic", name: "Energy Unit Conversions (Atomic/Energy)", description: "Joules to Electronvolts.", category: "calculator", icon: "⚡", free: true },
  { slug: "pressure-converter-high-range", name: "Pressure Converter (High Range)", description: "Megapascals to Atmospheres.", category: "calculator", icon: "💨", free: true },
  { slug: "torque-force-lever-simulation", name: "Torque/Force Lever Simulation", description: "Visual see-saw physics.", category: "calculator", icon: "⚖️", free: true },
  { slug: "centripetal-motion-simulator", name: "Centripetal Motion Simulator", description: "Rotating object visualization.", category: "calculator", icon: "🌀", free: true },
  { slug: "ohms-law-interactive-circuit", name: "Ohm's Law Interactive Circuit", description: "Resistor/Voltage/Current diagram.", category: "calculator", icon: "⚡", free: true },
  { slug: "resistor-code-4-5-6-band", name: "Resistor Code (4/5/6 Band)", description: "Click-and-select color band visualizer.", category: "calculator", icon: "🎨", free: true },
  { slug: "frequency-to-wave-period", name: "Frequency to Wave-period Calculator", description: "Scientific wave analysis.", category: "calculator", icon: "📡", free: true },
  { slug: "doppler-effect-audio-frequency", name: "Doppler Effect (Audio Frequency Shift)", description: "Visualizes the pitch change.", category: "calculator", icon: "🚗", free: true },
  { slug: "projectile-motion-launch-angle", name: "Projectile Motion (Launch Angle/Velocity)", description: "Visual trajectory curve.", category: "calculator", icon: "🎯", free: true },
  { slug: "optics-magnification-calculator", name: "Optics: Magnification Calculator", description: "Lens and mirror math.", category: "calculator", icon: "🔍", free: true },
  { slug: "logic-gate-circuit-builder", name: "Logic Gate Circuit Builder", description: "Drag-and-drop AND/OR/NAND/NOR gates.", category: "calculator", icon: "🔌", free: true },
  ...
  { slug: "data-entropy-shannon-index", name: "Data Entropy (Shannon Index)", description: "Measures randomness in byte data.", category: "calculator", icon: "📊", free: true },
  ...
  { slug: "km-to-mile-converter", name: "Kilometer to Mile Converter", description: "Convert KM to Miles.", category: "calculator", icon: "🚗", free: true },
  { slug: "kg-to-gram-converter", name: "Kilogram to Gram Converter", description: "Convert KG to Grams.", category: "calculator", icon: "⚖️", free: true },
  ...
  { slug: "gallon-to-liter-converter", name: "Gallon to Liter Converter", description: "Convert UK/US Gallons to Liters.", category: "calculator", icon: "🛢️", free: true },
  ...
  { slug: "byte-to-kb-converter", name: "Byte to Kilobyte Converter", description: "Data size conversion.", category: "calculator", icon: "💾", free: true },
  ...
  { slug: "quadratic-equation-solver-tool", name: "Quadratic Equation Solver", description: "Find roots of second-degree equations.", category: "calculator", icon: "📐", free: true },
  ...
  { slug: "income-tax-calculator", name: "Income Tax Calculator", description: "Estimate tax based on income brackets.", category: "calculator", icon: "🏛️", free: true },
  ...
  { slug: "heart-rate-calculator", name: "Heart Rate Calculator", description: "Calculate BPM based on pulses.", category: "calculator", icon: "💓", free: true },
  { slug: "target-heart-rate-calculator", name: "Target Heart Rate Calculator", description: "Find optimal HR zones for exercise.", category: "calculator", icon: "🏃", free: true },
  { slug: "pregnancy-due-date-calculator", name: "Pregnancy Due Date Calculator", description: "Estimate baby's arrival date.", category: "calculator", icon: "👶", free: true },
  { slug: "speed-distance-time-calculator", name: "Speed, Distance, Time Calculator", description: "Solve d = vt problems.", category: "calculator", icon: "🏃", free: true },
  { slug: "acceleration-calculator-tool", name: "Acceleration Calculator", description: "Find change in velocity over time.", category: "calculator", icon: "🚀", free: true },
  { slug: "force-calculator-tool", name: "Force Calculator (F=ma)", description: "Calculate force in Newtons.", category: "calculator", icon: "💥", free: true },
  { slug: "work-calculator-tool", name: "Work Calculator", description: "Calculate work in Joules.", category: "calculator", icon: "🏗️", free: true },
  { slug: "power-calculator-physics", name: "Power Calculator", description: "Find power in Watts.", category: "calculator", icon: "⚡", free: true },
  { slug: "kinetic-energy-calculator-tool", name: "Kinetic Energy Calculator", description: "Energy of a moving object.", category: "calculator", icon: "🏃", free: true },
  { slug: "potential-energy-calculator-tool", name: "Potential Energy Calculator", description: "Energy based on height and mass.", category: "calculator", icon: "⛰️", free: true },
  { slug: "momentum-calculator-tool", name: "Momentum Calculator", description: "Find p = mv.", category: "calculator", icon: "🎳", free: true },
  { slug: "density-calculator-tool", name: "Density Calculator", description: "Calculate mass / volume ratio.", category: "calculator", icon: "🧪", free: true },
  { slug: "voltage-drop-calculator", name: "Voltage Drop Calculator", description: "Calculate electrical loss over distance.", category: "calculator", icon: "⚡", free: true },
  { slug: "concrete-volume-calculator", name: "Concrete Volume Calculator", description: "Calculate yardage for slabs or footers.", category: "calculator", icon: "🏗️", free: true },
  { slug: "brick-quantity-calculator", name: "Brick Quantity Calculator", description: "Estimate bricks needed for a wall.", category: "calculator", icon: "🧱", free: true },
  ...
  { slug: "conversion-rate-calculator-tool", name: "Conversion Rate Calculator", description: "Calculate percentage of visitors who purchase.", category: "calculator", icon: "📊", free: true },
  { slug: "nps-calculator-tool", name: "Net Promoter Score (NPS) Calculator", description: "Measure customer loyalty/satisfaction.", category: "calculator", icon: "🙋", free: true },
  { slug: "churn-rate-calculator-tool", name: "Churn Rate Calculator", description: "Calculate customer loss rate.", category: "calculator", icon: "📉", free: true },
  { slug: "markup-calculator-tool", name: "Markup Calculator", description: "Find selling price based on cost.", category: "calculator", icon: "💰", free: true },
  { slug: "commission-calculator-tool", name: "Sales Commission Calculator", description: "Calculate earnings based on sales volume.", category: "calculator", icon: "💸", free: true },
  { slug: "sales-growth-calculator-tool", name: "Sales Growth Calculator", description: "Measure revenue increase over time.", category: "calculator", icon: "📈", free: true },
  { slug: "roas-calculator-tool", name: "ROAS (Return on Ad Spend) Calculator", description: "Efficiency of marketing spend.", category: "calculator", icon: "📣", free: true },

  // Advanced Calculators (Statistics, Chemistry, Electronics, etc.)
  { slug: "z-score-calculator", name: "Z-score Calculator", description: "Professional z-score calculator.", category: "calculator", icon: "📊", free: true },
  { slug: "confidence-interval-calculator", name: "Confidence Interval Calculator", description: "Professional confidence interval calculator.", category: "calculator", icon: "📊", free: true },
  { slug: "sample-size-calculator", name: "Sample Size Calculator", description: "Professional sample size calculator.", category: "calculator", icon: "📊", free: true },
  { slug: "regression-line-calculator", name: "Regression Line Calculator", description: "Professional regression line calculator.", category: "calculator", icon: "📊", free: true },
  { slug: "probability-distribution-calculator", name: "Probability Distribution Calculator", description: "Professional probability distribution calculator.", category: "calculator", icon: "📊", free: true },
  { slug: "binomial-probability-calculator", name: "Binomial Probability Calculator", description: "Professional binomial probability calculator.", category: "calculator", icon: "📊", free: true },
  { slug: "poisson-distribution-calculator", name: "Poisson Distribution Calculator", description: "Professional poisson distribution calculator.", category: "calculator", icon: "📊", free: true },
  { slug: "normal-distribution-calculator", name: "Normal Distribution Calculator", description: "Professional normal distribution calculator.", category: "calculator", icon: "📊", free: true },
  { slug: "chi-square-calculator", name: "Chi-square Calculator", description: "Professional chi-square calculator.", category: "calculator", icon: "📊", free: true },
  { slug: "p-value-calculator", name: "P-value Calculator", description: "Professional p-value calculator.", category: "calculator", icon: "📊", free: true },
  { slug: "variance-calculator", name: "Variance Calculator", description: "Professional variance calculator.", category: "calculator", icon: "📊", free: true },
  { slug: "interquartile-range-calculator", name: "Interquartile Range Calculator", description: "Professional interquartile range calculator.", category: "calculator", icon: "📊", free: true },
  { slug: "percentile-calculator", name: "Percentile Calculator", description: "Professional percentile calculator.", category: "calculator", icon: "📊", free: true },
  { slug: "geometric-mean-calculator", name: "Geometric Mean Calculator", description: "Professional geometric mean calculator.", category: "calculator", icon: "📊", free: true },
  { slug: "harmonic-mean-calculator", name: "Harmonic Mean Calculator", description: "Professional harmonic mean calculator.", category: "calculator", icon: "📊", free: true },
  { slug: "weighted-average-calculator", name: "Weighted Average Calculator", description: "Professional weighted average calculator.", category: "calculator", icon: "📊", free: true },
  { slug: "margin-of-error-calculator", name: "Margin Of Error Calculator", description: "Professional margin of error calculator.", category: "calculator", icon: "📊", free: true },
  { slug: "relative-risk-calculator", name: "Relative Risk Calculator", description: "Professional relative risk calculator.", category: "calculator", icon: "📊", free: true },
  { slug: "odds-ratio-calculator", name: "Odds Ratio Calculator", description: "Professional odds ratio calculator.", category: "calculator", icon: "📊", free: true },
  { slug: "molar-mass-calculator", name: "Molar Mass Calculator", description: "Professional molar mass calculator.", category: "calculator", icon: "🧪", free: true },
  { slug: "molarity-calculator", name: "Molarity Calculator", description: "Professional molarity calculator.", category: "calculator", icon: "🧪", free: true },
  { slug: "molality-calculator", name: "Molality Calculator", description: "Professional molality calculator.", category: "calculator", icon: "🧪", free: true },
  { slug: "normality-calculator", name: "Normality Calculator", description: "Professional normality calculator.", category: "calculator", icon: "🧪", free: true },
  { slug: "dilution-calculator", name: "Dilution Calculator", description: "Professional dilution calculator.", category: "calculator", icon: "🧪", free: true },
  { slug: "solution-concentration-calculator", name: "Solution Concentration Calculator", description: "Professional solution concentration calculator.", category: "calculator", icon: "🧪", free: true },
  { slug: "gas-density-calculator", name: "Gas Density Calculator", description: "Professional gas density calculator.", category: "calculator", icon: "🧪", free: true },
  { slug: "ideal-gas-law-calculator", name: "Ideal Gas Law Calculator", description: "Professional ideal gas law calculator.", category: "calculator", icon: "🧪", free: true },
  { slug: "partial-pressure-calculator", name: "Partial Pressure Calculator", description: "Professional partial pressure calculator.", category: "calculator", icon: "🧪", free: true },
  { slug: "reaction-yield-calculator", name: "Reaction Yield Calculator", description: "Professional reaction yield calculator.", category: "calculator", icon: "🧪", free: true },
  { slug: "limiting-reagent-calculator", name: "Limiting Reagent Calculator", description: "Professional limiting reagent calculator.", category: "calculator", icon: "🧪", free: true },
  { slug: "chemical-equation-balancer", name: "Chemical Equation Balancer", description: "Professional chemical equation balancer.", category: "calculator", icon: "🧪", free: true },
  { slug: "equilibrium-constant-calculator", name: "Equilibrium Constant Calculator", description: "Professional equilibrium constant calculator.", category: "calculator", icon: "🧪", free: true },
  { slug: "ph-calculator", name: "PH Calculator", description: "Professional ph calculator.", category: "calculator", icon: "🧪", free: true },
  { slug: "poh-calculator", name: "POH Calculator", description: "Professional poh calculator.", category: "calculator", icon: "🧪", free: true },
  { slug: "buffer-solution-calculator", name: "Buffer Solution Calculator", description: "Professional buffer solution calculator.", category: "calculator", icon: "🧪", free: true },
  { slug: "electrolysis-calculator", name: "Electrolysis Calculator", description: "Professional electrolysis calculator.", category: "calculator", icon: "🧪", free: true },
  { slug: "faraday-law-calculator", name: "Faraday Law Calculator", description: "Professional faraday law calculator.", category: "calculator", icon: "🧪", free: true },
  { slug: "reaction-rate-calculator", name: "Reaction Rate Calculator", description: "Professional reaction rate calculator.", category: "calculator", icon: "🧪", free: true },
  { slug: "voltage-divider-calculator", name: "Voltage Divider Calculator", description: "Professional voltage divider calculator.", category: "calculator", icon: "⚙️", free: true },
  { slug: "current-divider-calculator", name: "Current Divider Calculator", description: "Professional current divider calculator.", category: "calculator", icon: "⚙️", free: true },
  { slug: "rc-time-constant-calculator", name: "RC Time Constant Calculator", description: "Professional rc time constant calculator.", category: "calculator", icon: "⚙️", free: true },
  { slug: "rl-time-constant-calculator", name: "RL Time Constant Calculator", description: "Professional rl time constant calculator.", category: "calculator", icon: "⚙️", free: true },
  { slug: "lc-resonance-frequency-calculator", name: "LC Resonance Frequency Calculator", description: "Professional lc resonance frequency calculator.", category: "calculator", icon: "⚙️", free: true },
  { slug: "signal-period-calculator", name: "Signal Period Calculator", description: "Professional signal period calculator.", category: "calculator", icon: "⚙️", free: true },
  { slug: "frequency-to-wavelength-calculator", name: "Frequency To Wavelength Calculator", description: "Professional frequency to wavelength calculator.", category: "calculator", icon: "⚙️", free: true },
  { slug: "inductor-energy-calculator", name: "Inductor Energy Calculator", description: "Professional inductor energy calculator.", category: "calculator", icon: "⚙️", free: true },
  { slug: "capacitor-charge-calculator", name: "Capacitor Charge Calculator", description: "Professional capacitor charge calculator.", category: "calculator", icon: "⚙️", free: true },
  { slug: "capacitor-discharge-calculator", name: "Capacitor Discharge Calculator", description: "Professional capacitor discharge calculator.", category: "calculator", icon: "⚙️", free: true },
  { slug: "battery-life-calculator", name: "Battery Life Calculator", description: "Professional battery life calculator.", category: "calculator", icon: "⚙️", free: true },
  { slug: "solar-panel-output-calculator", name: "Solar Panel Output Calculator", description: "Professional solar panel output calculator.", category: "calculator", icon: "⚙️", free: true },
  { slug: "led-current-calculator", name: "LED Current Calculator", description: "Professional led current calculator.", category: "calculator", icon: "⚙️", free: true },
  { slug: "transistor-gain-calculator", name: "Transistor Gain Calculator", description: "Professional transistor gain calculator.", category: "calculator", icon: "⚙️", free: true },
  { slug: "amplifier-gain-calculator", name: "Amplifier Gain Calculator", description: "Professional amplifier gain calculator.", category: "calculator", icon: "⚙️", free: true },
  { slug: "decibel-calculator", name: "Decibel Calculator", description: "Professional decibel calculator.", category: "calculator", icon: "⚙️", free: true },
  { slug: "signal-to-noise-ratio-calculator", name: "Signal-to-noise Ratio Calculator", description: "Professional signal-to-noise ratio calculator.", category: "calculator", icon: "⚙️", free: true },
  { slug: "pwm-duty-cycle-calculator", name: "PWM Duty Cycle Calculator", description: "Professional pwm duty cycle calculator.", category: "calculator", icon: "⚙️", free: true },
  { slug: "switching-frequency-calculator", name: "Switching Frequency Calculator", description: "Professional switching frequency calculator.", category: "calculator", icon: "⚙️", free: true },
  { slug: "electrical-efficiency-calculator", name: "Electrical Efficiency Calculator", description: "Professional electrical efficiency calculator.", category: "calculator", icon: "⚙️", free: true },
  { slug: "tile-quantity-calculator", name: "Tile Quantity Calculator", description: "Professional tile quantity calculator.", category: "calculator", icon: "🏗️", free: true },
  { slug: "carpet-area-calculator", name: "Carpet Area Calculator", description: "Professional carpet area calculator.", category: "calculator", icon: "🏗️", free: true },
  { slug: "land-area-calculator", name: "Land Area Calculator", description: "Professional land area calculator.", category: "calculator", icon: "🏗️", free: true },
  { slug: "stair-rise-and-run-calculator", name: "Stair Rise And Run Calculator", description: "Professional stair rise and run calculator.", category: "calculator", icon: "🏗️", free: true },
  { slug: "fence-length-calculator", name: "Fence Length Calculator", description: "Professional fence length calculator.", category: "calculator", icon: "🏗️", free: true },
  { slug: "driveway-material-calculator", name: "Driveway Material Calculator", description: "Professional driveway material calculator.", category: "calculator", icon: "🏗️", free: true },
  { slug: "gravel-quantity-calculator", name: "Gravel Quantity Calculator", description: "Professional gravel quantity calculator.", category: "calculator", icon: "🏗️", free: true },
  { slug: "asphalt-quantity-calculator", name: "Asphalt Quantity Calculator", description: "Professional asphalt quantity calculator.", category: "calculator", icon: "🏗️", free: true },
  { slug: "insulation-thickness-calculator", name: "Insulation Thickness Calculator", description: "Professional insulation thickness calculator.", category: "calculator", icon: "🏗️", free: true },
  { slug: "roof-area-calculator", name: "Roof Area Calculator", description: "Professional roof area calculator.", category: "calculator", icon: "🏗️", free: true },
  { slug: "door-frame-size-calculator", name: "Door Frame Size Calculator", description: "Professional door frame size calculator.", category: "calculator", icon: "🏗️", free: true },
  { slug: "window-area-calculator", name: "Window Area Calculator", description: "Professional window area calculator.", category: "calculator", icon: "🏗️", free: true },
  { slug: "ceiling-area-calculator", name: "Ceiling Area Calculator", description: "Professional ceiling area calculator.", category: "calculator", icon: "🏗️", free: true },
  { slug: "foundation-volume-calculator", name: "Foundation Volume Calculator", description: "Professional foundation volume calculator.", category: "calculator", icon: "🏗️", free: true },
  { slug: "wall-brick-spacing-calculator", name: "Wall Brick Spacing Calculator", description: "Professional wall brick spacing calculator.", category: "calculator", icon: "🏗️", free: true },
  { slug: "binary-addition-calculator", name: "Binary Addition Calculator", description: "Professional binary addition calculator.", category: "calculator", icon: "💻", free: true },
  { slug: "binary-subtraction-calculator", name: "Binary Subtraction Calculator", description: "Professional binary subtraction calculator.", category: "calculator", icon: "💻", free: true },
  { slug: "binary-multiplication-calculator", name: "Binary Multiplication Calculator", description: "Professional binary multiplication calculator.", category: "calculator", icon: "💻", free: true },
  { slug: "binary-division-calculator", name: "Binary Division Calculator", description: "Professional binary division calculator.", category: "calculator", icon: "💻", free: true },
  { slug: "ip-subnet-calculator", name: "IP Subnet Calculator", description: "Professional ip subnet calculator.", category: "calculator", icon: "💻", free: true },
  { slug: "cidr-calculator", name: "CIDR Calculator", description: "Professional cidr calculator.", category: "calculator", icon: "💻", free: true },
  { slug: "network-bandwidth-calculator", name: "Network Bandwidth Calculator", description: "Professional network bandwidth calculator.", category: "calculator", icon: "💻", free: true },
  { slug: "data-transfer-time-calculator", name: "Data Transfer Time Calculator", description: "Professional data transfer time calculator.", category: "calculator", icon: "💻", free: true },
  { slug: "bitrate-calculator", name: "Bitrate Calculator", description: "Professional bitrate calculator.", category: "calculator", icon: "💻", free: true },
  { slug: "crc-calculator", name: "CRC Calculator", description: "Professional crc calculator.", category: "calculator", icon: "💻", free: true },
  { slug: "hash-generator-calculator", name: "Hash Generator Calculator", description: "Professional hash generator calculator.", category: "calculator", icon: "💻", free: true },
  { slug: "ascii-to-text-converter", name: "ASCII To Text Converter", description: "Professional ascii to text converter.", category: "calculator", icon: "💻", free: true },
  { slug: "text-to-ascii-converter", name: "Text To ASCII Converter", description: "Professional text to ascii converter.", category: "calculator", icon: "💻", free: true },
  { slug: "unicode-converter", name: "Unicode Converter", description: "Professional unicode converter.", category: "calculator", icon: "💻", free: true },
  { slug: "travel-speed-calculator", name: "Travel Speed Calculator", description: "Professional travel speed calculator.", category: "calculator", icon: "🚗", free: true },
  { slug: "distance-between-two-locations-calculator", name: "Distance Between Two Locations Calculator", description: "Professional distance between two locations calculator.", category: "calculator", icon: "🚗", free: true },
  { slug: "flight-time-calculator", name: "Flight Time Calculator", description: "Professional flight time calculator.", category: "calculator", icon: "🚗", free: true },
  { slug: "fuel-consumption-calculator", name: "Fuel Consumption Calculator", description: "Professional fuel consumption calculator.", category: "calculator", icon: "🚗", free: true },
  { slug: "car-depreciation-calculator", name: "Car Depreciation Calculator", description: "Professional car depreciation calculator.", category: "calculator", icon: "🚗", free: true },
  { slug: "trip-cost-calculator", name: "Trip Cost Calculator", description: "Professional trip cost calculator.", category: "calculator", icon: "🚗", free: true },
  { slug: "driving-time-calculator", name: "Driving Time Calculator", description: "Professional driving time calculator.", category: "calculator", icon: "🚗", free: true },
  { slug: "fuel-tank-range-calculator", name: "Fuel Tank Range Calculator", description: "Professional fuel tank range calculator.", category: "calculator", icon: "🚗", free: true },
  { slug: "tire-size-calculator", name: "Tire Size Calculator", description: "Professional tire size calculator.", category: "calculator", icon: "🚗", free: true },
  { slug: "gear-speed-calculator", name: "Gear Speed Calculator", description: "Professional gear speed calculator.", category: "calculator", icon: "🚗", free: true },
];
