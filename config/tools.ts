...
export const tools: Tool[] = [
  ...
  { slug: "feet-to-meter-converter", name: "Feet to Meters Converter", description: "Convert feet to meters, including height in feet and inches.", category: "calculator", icon: "📏", free: true },
  { slug: "kg-to-pound-converter", name: "Kilograms to Pounds Converter", description: "Convert kg to lbs and back, with stones.", category: "calculator", icon: "⚖️", free: true },
  { slug: "gram-to-ounce-converter", name: "Grams to Ounces Converter", description: "Convert grams to ounces for cooking.", category: "calculator", icon: "⚖️", free: true },
  { slug: "liter-to-ml-converter", name: "Liters to Milliliters Converter", description: "Convert liters to mL, cups and fluid ounces.", category: "calculator", icon: "🥤", free: true },
  ...
  { slug: "emoji-search-copy", name: "Emoji Search & Copy", description: "Search 1,914 emoji by name or keyword and click to copy.", category: "creator", icon: "😀", free: true },
  ...
  { slug: "f1-score-calculator", name: "F1 Score Calculator", description: "Calculate the F1 score, precision and recall from a confusion matrix or from precision and recall values.", category: "computer-science", icon: "🧮", free: true },
