...
export const tools: Tool[] = [
  ...
  // ── Computer Science & AI Tools (20 unique tools) ──
  ...
  { slug: "checksum-calculator", name: "Checksum Calculator", description: "Compute checksum for data validation.", category: "computer-science", icon: "✅", free: true },
  ...
  { slug: "serp-ctr-estimator", name: "SERP CTR Estimator", description: "Estimate organic click-through rate and traffic by Google ranking position. Compare positions, visualize the CTR curve, and forecast clicks — free and browser-based.", category: "marketing", icon: "📊", free: true },
  { slug: "page-rank-estimator", name: "Page Rank Estimator", description: "Estimate a page's Google ranking potential with a weighted SEO score covering content, technical, UX, and authority signals — free, browser-based, no signup.", category: "marketing", icon: "📈", free: true },
  ...
  { slug: "marketing-roi-calculator", name: "Marketing ROI Calculator", description: "Calculate marketing ROI, net profit, and profit ratio from campaign cost and revenue. Compare campaigns and track history — free and browser-based.", category: "marketing", icon: "📊", free: true },
  { slug: "lead-conversion-funnel-calculator", name: "Lead Conversion Funnel Calculator", description: "Calculate stage-by-stage conversion rates, drop-off percentages, and overall funnel efficiency with a live visual funnel — free and browser-based.", category: "marketing", icon: "🔄", free: true },
  ...
  { slug: "retention-rate-calculator", name: "Retention Rate Calculator", description: "Calculate customer, employee, or user retention rate with the standard formula. Get performance ratings and benchmarks — free and browser-based.", category: "marketing", icon: "📊", free: true },
  ...
  { slug: "page-speed-score-calculator", name: "Page Speed Score Calculator", description: "Estimate your website's performance score from Core Web Vitals — LCP, INP, CLS, FCP, TBT, and Speed Index — with a weighted score, letter grade, and optimization tips.", category: "data-analytics", icon: "⚡", free: true },
  { slug: "session-duration-calculator", name: "Session Duration Calculator", description: "Calculate average session duration and total session time from hours/minutes/seconds, total seconds, or bulk-pasted analytics data — with CSV and JSON export.", category: "data-analytics", icon: "⏱️", free: true },
  { slug: "click-heatmap-density-calculator", name: "Click Heatmap Density Calculator", description: "Visualize click distribution with an interactive canvas heatmap — upload a screenshot, import CSV/JSON coordinates, and analyze hotspots, cold zones, and density statistics.", category: "data-analytics", icon: "🔥", free: true },
  ...
  { slug: "storage-requirement-calculator", name: "Storage Requirement Calculator", description: "Estimate storage needs for files, backups, CCTV recording, databases, and cloud storage with compression, RAID, growth, and cost modeling built in.", category: "data-analytics", icon: "💾", free: true },
  { slug: "data-transfer-cost-calculator", name: "Data Transfer Cost Calculator", description: "Estimate cloud data transfer, bandwidth, and egress costs across GB, TB, PB, binary or decimal units, billing periods, and multiple currencies.", category: "data-analytics", icon: "💰", free: true },
  ...
  { slug: "data-pipeline-latency-calculator", name: "Data Pipeline Latency Calculator", description: "Estimate end-to-end data pipeline latency across unlimited sequential and parallel stages, with bottleneck detection and CSV/JSON export.", category: "data-analytics", icon: "⏱️", free: true },
  { slug: "mean-calculator", name: "Mean Calculator", description: "Compute average value.", category: "data-analytics", icon: "📊", free: true },
  { slug: "median-calculator", name: "Median Calculator", description: "Calculate the median of any dataset instantly with automatic sorting, step-by-step explanations, CSV/TXT upload, and downloadable reports.", category: "data-analytics", icon: "📊", free: true },
  { slug: "mode-calculator", name: "Mode Calculator", description: "Find most frequent value.", category: "data-analytics", icon: "📊", free: true },
  { slug: "standard-deviation-calculator", name: "Standard Deviation Calculator", description: "Calculate sample and population standard deviation with variance, quartiles, mode, and histogram/box plot visualization.", category: "data-analytics", icon: "📊", free: true },
  ...
  { slug: "correlation-coefficient-calculator", name: "Correlation Coefficient Calculator", description: "Calculate Pearson, Spearman, and Kendall correlation coefficients instantly with scatter plot visualization, regression line, outlier detection, and downloadable reports.", category: "data-analytics", icon: "📊", free: true },
  { slug: "regression-calculator", name: "Regression Calculator", description: "Perform simple linear regression instantly with slope, intercept, R², RMSE, MAE, prediction tools, and an interactive scatter plot with residual analysis.", category: "data-analytics", icon: "📈", free: true },
  { slug: "moving-average-calculator", name: "Moving Average Calculator", description: "Calculate Simple, Weighted, and Exponential Moving Averages instantly with an interactive trend chart, summary statistics, and downloadable reports.", category: "data-analytics", icon: "📊", free: true },
  { slug: "exponential-smoothing-calculator", name: "Exponential Smoothing Calculator", description: "Calculate simple, double, and triple exponential smoothing instantly with interactive charts, forecasts, and downloadable reports.", category: "data-analytics", icon: "📉", free: true },
  { slug: "sample-size-calculator", name: "Sample Size Calculator", description: "Calculate the minimum sample size needed for surveys, research studies, and polls with confidence level, margin of error, and finite population correction.", category: "data-analytics", icon: "📊", free: true },
  { slug: "confidence-interval-calculator", name: "Confidence Interval Calculator", description: "Calculate confidence intervals for a mean or proportion, margin of error, and required sample size — with Z and t critical values and formula breakdown.", category: "data-analytics", icon: "📊", free: true },
  { slug: "a-b-test-calculator", name: "A/B Test Calculator", description: "Analyze A/B test results with a two-proportion z-test — conversion rates, lift, Z-scores, p-values, and statistical significance.", category: "data-analytics", icon: "🧪", free: true },
  { slug: "p-value-calculator", name: "P-Value Calculator", description: "Calculate p-values and statistical significance for Z-tests, T-tests, Chi-Square tests, F-tests, and correlation tests instantly.", category: "data-analytics", icon: "📊", free: true },
  { slug: "chi-square-calculator", name: "Chi-Square Calculator", description: "Perform Chi-Square Goodness of Fit and Test of Independence with step-by-step calculations, p-values, expected frequencies, and Cramér's V effect size.", category: "data-analytics", icon: "📊", free: true },
  { slug: "data-normalization-calculator", name: "Data Normalization Calculator", description: "Normalize numeric datasets using Min-Max, Z-Score, Decimal Scaling, Unit Vector, Mean Normalization, or Robust Scaling with before/after comparison.", category: "data-analytics", icon: "📊", free: true },
  { slug: "min-max-scaling-calculator", name: "Min-Max Scaling Calculator", description: "Normalize datasets instantly using min-max scaling — scale numbers to any custom range including 0–1 or -1–1 for machine learning and statistics.", category: "data-analytics", icon: "📊", free: true },
  { slug: "log-transformation-calculator", name: "Log Transformation Calculator", description: "Transform single values or datasets using natural log (ln), log10, log2, or a custom base with summary statistics.", category: "data-analytics", icon: "📊", free: true },
  { slug: "precision-calculator", name: "Precision Calculator", description: "Calculate the Precision metric from True Positive and False Positive counts, with percentage conversion and performance rating.", category: "data-analytics", icon: "🎯", free: true },
  { slug: "recall-calculator", name: "Recall Calculator", description: "Calculate the Recall (Sensitivity) metric from True Positive and False Negative counts, with confusion matrix mode and performance rating.", category: "data-analytics", icon: "🎯", free: true },
  { slug: "f1-score-calculator-analytics", name: "F1 Score Calculator", description: "Calculate the F1 Score from Precision and Recall, or directly from a confusion matrix (TP, FP, FN), with step-by-step breakdown and performance rating.", category: "data-analytics", icon: "📊", free: true },
  { slug: "roc-auc-calculator", name: "ROC AUC Calculator", description: "Calculate the ROC curve and AUC score from binary classification results with an interactive curve, threshold explorer, and CSV upload.", category: "data-analytics", icon: "📊", free: true },
  { slug: "confusion-matrix-analyzer", name: "Confusion Matrix Analyzer", description: "Analyze binary and multi-class classification results with accuracy, precision, recall, F1, specificity, MCC, and a live confusion matrix heatmap.", category: "data-analytics", icon: "📊", free: true },
  { slug: "clustering-distance-calculator", name: "Clustering Distance Calculator", description: "Calculate Euclidean, Manhattan, Cosine, Minkowski, and seven other distance metrics between two vectors instantly, with step-by-step breakdowns.", category: "data-analytics", icon: "📊", free: true },
  { slug: "data-compression-ratio-calculator", name: "Data Compression Ratio Calculator", description: "Calculate compression ratio, storage savings, and reduction percentage from original and compressed file sizes with an efficiency rating.", category: "data-analytics", icon: "📦", free: true },
  { slug: "encoding-efficiency-calculator", name: "Encoding Efficiency Calculator", description: "Calculate encoding overhead, expansion ratio, compression ratio, and encoding efficiency from original and encoded data sizes, with a comparison table for Base64, Hex, and other methods.", category: "data-analytics", icon: "🔢", free: true },
  { slug: "time-series-forecast-calculator", name: "Time Series Forecast Calculator", description: "Forecast future values from historical data using Moving Average, Exponential Smoothing, Linear Trend, Seasonal Naive, and more — with interactive charts and CSV export.", category: "data-analytics", icon: "📈", free: true },
  { slug: "seasonality-index-calculator", name: "Seasonality Index Calculator", description: "Calculate seasonality indexes from monthly, quarterly, weekly, or daily data with CSV import, interactive charts, and multiple calculation methods.", category: "data-analytics", icon: "📊", free: true },
  { slug: "big-data-throughput-calculator", name: "Big Data Throughput Calculator", description: "Estimate data processing throughput, processing time, and required data rate for ETL pipelines and distributed systems — with unit conversion and export.", category: "data-analytics", icon: "💾", free: true },
  { slug: "cluster-utilization-calculator", name: "Cluster Utilization Calculator", description: "Calculate CPU, memory, storage, and GPU cluster utilization, remaining capacity, and headroom with live gauges and multi-resource dashboard.", category: "data-analytics", icon: "🖥️", free: true },
  { slug: "hadoop-storage-calculator", name: "Hadoop Storage Calculator", description: "Estimate HDFS storage requirements from raw data size, replication factor, compression ratio, and reserved space, with multi-year growth forecasting.", category: "data-analytics", icon: "💾", free: true },
  { slug: "spark-job-time-calculator", name: "Spark Job Time Calculator", description: "Estimate Apache Spark job execution time from dataset size and cluster resources, with a runtime breakdown, bottleneck detection, and optimization tips.", category: "data-analytics", icon: "⚡", free: true },
  { slug: "data-partition-calculator", name: "Data Partition Calculator", description: "Calculate partition size, required partitions, records per partition, and balanced data distribution across five calculation modes.", category: "data-analytics", icon: "📊", free: true },
  { slug: "query-optimization-calculator", name: "Query Optimization Calculator", description: "Estimate SQL query performance improvement from execution time, rows scanned, and query frequency — with before/after comparison and savings projections.", category: "data-analytics", icon: "⚡", free: true },
  { slug: "index-size-calculator", name: "Index Size Calculator", description: "Estimate database index storage size for PostgreSQL, MySQL, SQL Server, Oracle, MariaDB, and SQLite, with index type and compression comparison.", category: "data-analytics", icon: "💾", free: true },
  { slug: "cache-efficiency-calculator", name: "Cache Efficiency Calculator", description: "Calculate cache hit rate, miss rate, and performance rating instantly from your cache hits and misses.", category: "data-analytics", icon: "⚡", free: true },
  { slug: "data-sampling-calculator", name: "Data Sampling Calculator", description: "Calculate the required sample size for surveys and research using confidence level, margin of error, population size, and expected proportion.", category: "data-analytics", icon: "📊", free: true },
