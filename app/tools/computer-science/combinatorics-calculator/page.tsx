...
import { toolConfig as config } from "@/tools/combinatorics-calculator/config";

const CombinatoricsCalculatorUI = dynamic(() => import("@/tools/combinatorics-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/computer-science/combinatorics-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("combinatorics-calculator"),
