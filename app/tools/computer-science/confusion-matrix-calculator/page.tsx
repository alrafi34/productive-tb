...
import { toolConfig as config } from "@/tools/confusion-matrix-calculator/config";

const ConfusionMatrixCalculatorUI = dynamic(() => import("@/tools/confusion-matrix-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/computer-science/confusion-matrix-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("confusion-matrix-calculator"),
