...
import { toolConfig as config } from "@/tools/ai-token-cost-calculator/config";

const AITokenCostCalculatorUI = dynamic(() => import("@/tools/ai-token-cost-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/computer-science/ai-token-cost-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("ai-token-cost-calculator"),
