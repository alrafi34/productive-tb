...
import { toolConfig as config } from "@/tools/ai-prompt-length-calculator/config";

const AIPromptLengthCalculatorUI = dynamic(() => import("@/tools/ai-prompt-length-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/computer-science/ai-prompt-length-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("ai-prompt-length-calculator"),
...
export default function AiPromptLengthCalculatorPage() {
  const catObj = categories.find((c) => c.slug === "computer-science");
