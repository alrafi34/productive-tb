...
import { toolConfig as config } from "@/tools/f1-score-calculator/config";

const F1ScoreCalculatorUI = dynamic(() => import("@/tools/f1-score-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/computer-science/f1-score-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("f1-score-calculator"),
