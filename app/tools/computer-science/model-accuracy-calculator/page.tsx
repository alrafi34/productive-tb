...
import { toolConfig as config } from "@/tools/model-accuracy-calculator/config";

const ModelAccuracyCalculatorUI = dynamic(() => import("@/tools/model-accuracy-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/computer-science/model-accuracy-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("model-accuracy-calculator"),
