...
import { toolConfig as config } from "@/tools/cloud-cost-calculator/config";

const CloudCostCalculatorUI = dynamic(() => import("@/tools/cloud-cost-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/computer-science/cloud-cost-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("cloud-cost-calculator"),
