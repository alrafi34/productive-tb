...
import { toolConfig as config } from "@/tools/precision-recall-calculator/config";

const PrecisionRecallCalculatorUI = dynamic(() => import("@/tools/precision-recall-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/computer-science/precision-recall-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("precision-recall-calculator"),
