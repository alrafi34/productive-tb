...
import { toolConfig as config } from "@/tools/dataset-split-calculator/config";

const DatasetSplitCalculatorUI = dynamic(() => import("@/tools/dataset-split-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/computer-science/dataset-split-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("dataset-split-calculator"),
