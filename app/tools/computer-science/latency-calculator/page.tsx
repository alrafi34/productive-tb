...
import { toolConfig as config } from "@/tools/latency-calculator/config";

const LatencyCalculatorUI = dynamic(() => import("@/tools/latency-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/computer-science/latency-calculator`;
