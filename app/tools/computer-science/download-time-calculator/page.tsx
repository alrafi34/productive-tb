...
import { toolConfig as config } from "@/tools/download-time-calculator/config";

const DownloadTimeCalculatorUI = dynamic(() => import("@/tools/download-time-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/computer-science/download-time-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("download-time-calculator"),
