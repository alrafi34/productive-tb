...
import { toolConfig as config } from "@/tools/favicon-generator/config";

const FaviconGeneratorUI = dynamic(() => import("@/tools/favicon-generator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/image/favicon-generator`;
