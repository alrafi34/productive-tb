...
import { toolConfig as config } from "@/tools/image-compressor/config";

const ImageCompressorUI = dynamic(() => import("@/tools/image-compressor/ui"));

const canonicalUrl = `${siteConfig.url}/tools/image/image-compressor`;
