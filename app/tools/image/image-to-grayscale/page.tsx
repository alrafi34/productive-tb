...
import { toolConfig as config } from "@/tools/image-to-grayscale/config";

const ImageToGrayscaleUI = dynamic(() => import("@/tools/image-to-grayscale/ui"));

const canonicalUrl = `${siteConfig.url}/tools/image/image-to-grayscale`;
...
export default function ImageToGrayscalePage() {
  const catObj = categories.find((c) => c.slug === "image");
