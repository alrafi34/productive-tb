...
import { emojiSearchCopyConfig as config } from "@/tools/emoji-search-copy/config";

const EmojiSearchCopyUI = dynamic(() => import("@/tools/emoji-search-copy/ui"));

const canonicalUrl = `${siteConfig.url}/tools/creator/emoji-search-copy`;
...
export default function EmojiSearchCopyPage() {
  const catObj = categories.find((c) => c.slug === "creator");
