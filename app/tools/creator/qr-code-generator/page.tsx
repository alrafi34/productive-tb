...
import { qrCodeGeneratorConfig as config } from "@/tools/qr-code-generator/config";

const QrCodeGeneratorUI = dynamic(() => import("@/tools/qr-code-generator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/creator/qr-code-generator`;
