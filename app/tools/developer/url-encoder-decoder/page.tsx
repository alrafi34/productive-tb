...
import { toolConfig as config } from "@/tools/url-encoder-decoder/config";

const UrlEncoderDecoderUI = dynamic(() => import("@/tools/url-encoder-decoder/ui"));

const canonicalUrl = `${siteConfig.url}/tools/developer/url-encoder-decoder`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("url-encoder-decoder"),
