...
import { base64EncoderDecoderConfig as config } from "@/tools/base64-encoder-decoder/config";

const Base64EncoderDecoderUI = dynamic(() => import("@/tools/base64-encoder-decoder/ui"));

const canonicalUrl = `${siteConfig.url}/tools/developer/base64-encoder-decoder`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("base64-encoder-decoder"),
...
export default function Base64EncoderDecoderPage() {
  const catObj = categories.find((c) => c.slug === "developer");
