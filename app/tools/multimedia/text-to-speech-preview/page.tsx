...
import { toolConfig as config } from "@/tools/text-to-speech-preview/config";

const TextToSpeechPreviewUI = dynamic(() => import("@/tools/text-to-speech-preview/ui"));

const canonicalUrl = `${siteConfig.url}/tools/multimedia/text-to-speech-preview`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("text-to-speech-preview"),
...
export default function TextToSpeechPreviewPage() {
  const catObj = categories.find((c) => c.slug === "multimedia");
