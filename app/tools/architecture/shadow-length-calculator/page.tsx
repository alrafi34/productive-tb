...
import { shadowLengthCalculatorConfig as config } from "@/tools/shadow-length-calculator/config";

const ShadowLengthCalculatorUI = dynamic(() => import("@/tools/shadow-length-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/architecture/shadow-length-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("shadow-length-calculator"),
...
export default function ShadowLengthCalculatorPage() {
