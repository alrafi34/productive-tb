...
import { escalationCostCalculatorConfig as config } from "@/tools/escalation-cost-calculator/config";

const EscalationCostCalculatorUI = dynamic(() => import("@/tools/escalation-cost-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/architecture/escalation-cost-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("escalation-cost-calculator"),
...
export default function EscalationCostCalculatorPage() {
