...
import { sunlightExposureCalculatorConfig as config } from "@/tools/sunlight-exposure-calculator/config";

const SunlightExposureCalculatorUI = dynamic(() => import("@/tools/sunlight-exposure-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/architecture/sunlight-exposure-calculator`;

const seo = (config as any).seo ?? {};
const toolName = (config as any).name ?? (config as any).title ?? "sunlight-exposure-calculator";
...
export const metadata: Metadata = {
  ...
  ...toolRobots("sunlight-exposure-calculator"),
...
export default function SunlightExposureCalculatorPage() {
