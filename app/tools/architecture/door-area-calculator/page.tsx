...
import { doorAreaCalculatorConfig as config } from "@/tools/door-area-calculator/config";

const DoorAreaCalculatorUI = dynamic(() => import("@/tools/door-area-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/architecture/door-area-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("door-area-calculator"),
