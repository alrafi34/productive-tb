...
import { parkingSpaceCalculatorConfig as config } from "@/tools/parking-space-calculator/config";

const ParkingSpaceCalculatorUI = dynamic(() => import("@/tools/parking-space-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/architecture/parking-space-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("parking-space-calculator"),
...
export default function ParkingSpaceCalculatorPage() {
