...
import { sustainabilityIndexCalculatorConfig as config } from "@/tools/sustainability-index-calculator/config";

const SustainabilityIndexCalculatorUI = dynamic(() => import("@/tools/sustainability-index-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/architecture/sustainability-index-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("sustainability-index-calculator"),
