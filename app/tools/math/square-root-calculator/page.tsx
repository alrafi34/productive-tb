...
import { toolConfig as config } from "@/tools/square-root-calculator/config";

const SquareRootCalculatorUI = dynamic(() => import("@/tools/square-root-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/math/square-root-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("square-root-calculator"),
