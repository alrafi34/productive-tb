...
import { toolConfig as config } from "@/tools/random-number-generator/config";

const RandomNumberGeneratorUI = dynamic(() => import("@/tools/random-number-generator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/math/random-number-generator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("random-number-generator"),
...
export default function RandomNumberGeneratorPage() {
  const catObj = categories.find((c) => c.slug === "math");
