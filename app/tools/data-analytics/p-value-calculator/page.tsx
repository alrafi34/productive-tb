...
import { pValueCalculatorConfig as config } from "@/tools/p-value-calculator/config";
import { categories } from "@/config/tools";

const PValueCalculatorUI = dynamic(
  () => import("@/tools/p-value-calculator/ui")
);

const canonicalUrl = `${siteConfig.url}/tools/data-analytics/p-value-calculator`;
...
export const metadata: Metadata = {
  ...
  openGraph: {
    images: [{ url: "/og?title=P-Value+Calculator", width: 1200, height: 630, alt: "P-Value Calculator" }],
  ...
  twitter: {
    images: ["/og?title=P-Value+Calculator"],
