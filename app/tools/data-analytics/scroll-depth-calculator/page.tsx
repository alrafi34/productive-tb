...
import { scrollDepthCalculatorConfig as config } from "@/tools/scroll-depth-calculator/config";

const ScrollDepthCalculatorUI = dynamic(() => import("@/tools/scroll-depth-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/data-analytics/scroll-depth-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("scroll-depth-calculator"),
...
export default function ScrollDepthCalculatorPage() {
