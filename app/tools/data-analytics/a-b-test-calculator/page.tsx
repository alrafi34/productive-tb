...
import { abTestCalculatorConfig as config } from "@/tools/a-b-test-calculator/config";
import { categories } from "@/config/tools";

const ABTestCalculatorUI = dynamic(
  () => import("@/tools/a-b-test-calculator/ui")
);

const canonicalUrl = `${siteConfig.url}/tools/data-analytics/a-b-test-calculator`;
...
export const metadata: Metadata = {
  ...
  openGraph: {
    images: [{ url: "/og?title=A%2FB+Test+Calculator", width: 1200, height: 630, alt: "A/B Test Calculator" }],
  ...
  twitter: {
    images: ["/og?title=A%2FB+Test+Calculator"],
