...
import { varianceCalculatorConfig as config } from "@/tools/variance-calculator/config";

const VarianceCalculatorUI = dynamic(() => import("@/tools/variance-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/data-analytics/variance-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("variance-calculator"),
