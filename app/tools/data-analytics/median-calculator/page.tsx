...
import { medianCalculatorConfig as config } from "@/tools/median-calculator/config";
import { categories } from "@/config/tools";

const MedianCalculatorUI = dynamic(
  () => import("@/tools/median-calculator/ui")
);

const canonicalUrl = `${siteConfig.url}/tools/data-analytics/median-calculator`;
...
export const metadata: Metadata = {
  ...
  openGraph: {
    images: [{ url: "/og?title=Median+Calculator", width: 1200, height: 630, alt: "Median Calculator" }],
  ...
  twitter: {
    images: ["/og?title=Median+Calculator"],
