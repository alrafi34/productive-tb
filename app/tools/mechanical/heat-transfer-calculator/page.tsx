...
import { heatTransferCalculatorConfig as config } from "@/tools/heat-transfer-calculator/config";

const HeatTransferCalculatorUI = dynamic(() => import("@/tools/heat-transfer-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/mechanical/heat-transfer-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("heat-transfer-calculator"),
