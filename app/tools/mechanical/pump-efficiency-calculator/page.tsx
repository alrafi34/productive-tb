...
import { toolConfig as config } from "@/tools/pump-efficiency-calculator/config";

const PumpEfficiencyCalculatorUI = dynamic(() => import("@/tools/pump-efficiency-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/mechanical/pump-efficiency-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("pump-efficiency-calculator"),
