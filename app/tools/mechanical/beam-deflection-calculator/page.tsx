...
import { toolConfig as config } from "@/tools/beam-deflection-calculator/config";

const BeamDeflectionCalculatorUI = dynamic(() => import("@/tools/beam-deflection-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/mechanical/beam-deflection-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("beam-deflection-calculator"),
