...
import { stressCalculatorConfig as config } from "@/tools/stress-calculator/config";

const StressCalculatorUI = dynamic(() => import("@/tools/stress-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/mechanical/stress-calculator`;
