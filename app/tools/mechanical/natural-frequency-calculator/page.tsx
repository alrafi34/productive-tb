...
import { naturalFrequencyCalculatorConfig as config } from "@/tools/natural-frequency-calculator/config";

const NaturalFrequencyCalculatorUI = dynamic(() => import("@/tools/natural-frequency-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/mechanical/natural-frequency-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("natural-frequency-calculator"),
