...
import { dragForceCalculatorConfig as config } from "@/tools/drag-force-calculator/config";

const DragForceCalculatorUI = dynamic(() => import("@/tools/drag-force-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/mechanical/drag-force-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("drag-force-calculator"),
