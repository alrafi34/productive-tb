...
import { latheSpeedCalculatorConfig as config } from "@/tools/lathe-speed-calculator/config";

const LatheSpeedCalculatorUI = dynamic(() => import("@/tools/lathe-speed-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/mechanical/lathe-speed-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("lathe-speed-calculator"),
