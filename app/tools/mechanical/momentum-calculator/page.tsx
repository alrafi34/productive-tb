...
import { momentumCalculatorConfig as config } from "@/tools/momentum-calculator/config";

const MomentumCalculatorUI = dynamic(() => import("@/tools/momentum-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/mechanical/momentum-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("momentum-calculator"),
