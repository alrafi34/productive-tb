...
import { springForceCalculatorConfig as config } from "@/tools/spring-force-calculator/config";

const SpringForceCalculatorUI = dynamic(() => import("@/tools/spring-force-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/mechanical/spring-force-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("spring-force-calculator"),
