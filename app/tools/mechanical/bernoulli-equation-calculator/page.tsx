...
import { bernoulliEquationCalculatorConfig as config } from "@/tools/bernoulli-equation-calculator/config";

const BernoulliEquationCalculatorUI = dynamic(() => import("@/tools/bernoulli-equation-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/mechanical/bernoulli-equation-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("bernoulli-equation-calculator"),
...
export default function BernoulliEquationCalculatorPage() {
  const catObj = categories.find((c) => c.slug === "mechanical");
