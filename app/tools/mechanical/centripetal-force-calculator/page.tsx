...
import { centripetalForceCalculatorConfig as config } from "@/tools/centripetal-force-calculator/config";

const CentripetalForceCalculatorUI = dynamic(() => import("@/tools/centripetal-force-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/mechanical/centripetal-force-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("centripetal-force-calculator"),
