...
import { kineticEnergyCalculatorConfig as config } from "@/tools/kinetic-energy-calculator/config";

const KineticEnergyCalculatorUI = dynamic(() => import("@/tools/kinetic-energy-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/mechanical/kinetic-energy-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("kinetic-energy-calculator"),
