...
import { bearingLifeCalculatorConfig as config } from "@/tools/bearing-life-calculator/config";

const BearingLifeCalculatorUI = dynamic(() => import("@/tools/bearing-life-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/mechanical/bearing-life-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("bearing-life-calculator"),
