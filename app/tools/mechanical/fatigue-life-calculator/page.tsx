...
import { fatigueLifeCalculatorConfig as config } from "@/tools/fatigue-life-calculator/config";

const FatigueLifeCalculatorUI = dynamic(() => import("@/tools/fatigue-life-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/mechanical/fatigue-life-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("fatigue-life-calculator"),
