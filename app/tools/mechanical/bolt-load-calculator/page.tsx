...
import { boltLoadCalculatorConfig as config } from "@/tools/bolt-load-calculator/config";

const BoltLoadCalculatorUI = dynamic(() => import("@/tools/bolt-load-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/mechanical/bolt-load-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("bolt-load-calculator"),
