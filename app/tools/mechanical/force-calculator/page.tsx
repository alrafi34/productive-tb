...
import { forceCalculatorConfig as config } from "@/tools/force-calculator/config";

const ForceCalculatorUI = dynamic(() => import("@/tools/force-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/mechanical/force-calculator`;
