...
import { bendingMomentCalculatorConfig as config } from "@/tools/bending-moment-calculator/config";

const BendingMomentCalculatorUI = dynamic(() => import("@/tools/bending-moment-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/mechanical/bending-moment-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("bending-moment-calculator"),
