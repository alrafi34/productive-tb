...
import { flowRateCalculatorConfig as config } from "@/tools/flow-rate-calculator/config";

const FlowRateCalculatorUI = dynamic(() => import("@/tools/flow-rate-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/mechanical/flow-rate-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("flow-rate-calculator"),
