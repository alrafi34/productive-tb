...
import { feedRateCalculatorConfig as config } from "@/tools/feed-rate-calculator/config";

const FeedRateCalculatorUI = dynamic(() => import("@/tools/feed-rate-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/mechanical/feed-rate-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("feed-rate-calculator"),
