...
import { specificHeatCalculatorConfig as config } from "@/tools/specific-heat-calculator/config";

const SpecificHeatCalculatorUI = dynamic(() => import("@/tools/specific-heat-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/mechanical/specific-heat-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("specific-heat-calculator"),
