...
import { cuttingSpeedCalculatorConfig as config } from "@/tools/cutting-speed-calculator/config";

const CuttingSpeedCalculatorUI = dynamic(() => import("@/tools/cutting-speed-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/mechanical/cutting-speed-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("cutting-speed-calculator"),
