...
import { columnBucklingCalculatorConfig as config } from "@/tools/column-buckling-calculator/config";

const ColumnBucklingCalculatorUI = dynamic(() => import("@/tools/column-buckling-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/mechanical/column-buckling-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("column-buckling-calculator"),
