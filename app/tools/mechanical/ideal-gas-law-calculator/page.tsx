...
import { idealGasLawCalculatorConfig as config } from "@/tools/ideal-gas-law-calculator/config";

const IdealGasLawCalculatorUI = dynamic(() => import("@/tools/ideal-gas-law-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/mechanical/ideal-gas-law-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("ideal-gas-law-calculator"),
