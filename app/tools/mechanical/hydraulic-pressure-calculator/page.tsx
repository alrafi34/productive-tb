...
import { hydraulicPressureCalculatorConfig as config } from "@/tools/hydraulic-pressure-calculator/config";

const HydraulicPressureCalculatorUI = dynamic(() => import("@/tools/hydraulic-pressure-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/mechanical/hydraulic-pressure-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("hydraulic-pressure-calculator"),
