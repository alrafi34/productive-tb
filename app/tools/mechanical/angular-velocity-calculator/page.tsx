...
import { angularVelocityCalculatorConfig as config } from "@/tools/angular-velocity-calculator/config";

const AngularVelocityCalculatorUI = dynamic(() => import("@/tools/angular-velocity-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/mechanical/angular-velocity-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("angular-velocity-calculator"),
