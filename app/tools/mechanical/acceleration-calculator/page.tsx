...
import { accelerationCalculatorConfig as config } from "@/tools/acceleration-calculator/config";

const AccelerationCalculatorUI = dynamic(() => import("@/tools/acceleration-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/mechanical/acceleration-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("acceleration-calculator"),
