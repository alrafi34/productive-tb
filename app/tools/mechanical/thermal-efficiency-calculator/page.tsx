...
import { thermalEfficiencyCalculatorConfig as config } from "@/tools/thermal-efficiency-calculator/config";

const ThermalEfficiencyCalculatorUI = dynamic(() => import("@/tools/thermal-efficiency-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/mechanical/thermal-efficiency-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("thermal-efficiency-calculator"),
