...
import { reynoldsNumberCalculatorConfig as config } from "@/tools/reynolds-number-calculator/config";

const ReynoldsNumberCalculatorUI = dynamic(() => import("@/tools/reynolds-number-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/mechanical/reynolds-number-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("reynolds-number-calculator"),
