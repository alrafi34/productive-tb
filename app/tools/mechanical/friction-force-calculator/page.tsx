...
import { frictionForceCalculatorConfig as config } from "@/tools/friction-force-calculator/config";

const FrictionForceCalculatorUI = dynamic(() => import("@/tools/friction-force-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/mechanical/friction-force-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("friction-force-calculator"),
