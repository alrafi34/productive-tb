...
import { threadPitchCalculatorConfig as config } from "@/tools/thread-pitch-calculator/config";

const ThreadPitchCalculatorUI = dynamic(() => import("@/tools/thread-pitch-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/mechanical/thread-pitch-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("thread-pitch-calculator"),
