...
import { torqueCalculatorConfig as config } from "@/tools/torque-calculator/config";

const TorqueCalculatorUI = dynamic(() => import("@/tools/torque-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/mechanical/torque-calculator`;
