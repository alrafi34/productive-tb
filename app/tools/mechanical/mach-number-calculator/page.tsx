...
import { machNumberCalculatorConfig as config } from "@/tools/mach-number-calculator/config";

const MachNumberCalculatorUI = dynamic(() => import("@/tools/mach-number-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/mechanical/mach-number-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("mach-number-calculator"),
