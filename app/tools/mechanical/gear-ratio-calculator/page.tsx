...
import { gearRatioCalculatorConfig as config } from "@/tools/gear-ratio-calculator/config";

const GearRatioCalculatorUI = dynamic(() => import("@/tools/gear-ratio-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/mechanical/gear-ratio-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("gear-ratio-calculator"),
