...
import { pressureDropCalculatorConfig as config } from "@/tools/pressure-drop-calculator/config";

const PressureDropCalculatorUI = dynamic(() => import("@/tools/pressure-drop-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/mechanical/pressure-drop-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("pressure-drop-calculator"),
