...
import { toolConfig as config } from "@/tools/projectile-motion-calculator/config";

const ProjectileMotionCalculatorUI = dynamic(() => import("@/tools/projectile-motion-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/mechanical/projectile-motion-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("projectile-motion-calculator"),
