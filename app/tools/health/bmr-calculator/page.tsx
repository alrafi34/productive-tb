...
import { toolConfig as config } from "@/tools/bmr-calculator/config";

const BmrCalculatorUI = dynamic(() => import("@/tools/bmr-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/health/bmr-calculator`;
...
export default function BmrCalculatorPage() {
  const catObj = categories.find((c) => c.slug === "health");
