...
import { toolConfig as config } from "@/tools/voice-to-text-notepad/config";

const VoiceToTextNotepadUI = dynamic(() => import("@/tools/voice-to-text-notepad/ui"));

const canonicalUrl = `${siteConfig.url}/tools/productivity/voice-to-text-notepad`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("voice-to-text-notepad"),
...
export default function VoiceToTextNotepadPage() {
  const catObj = categories.find((c) => c.slug === "productivity");
