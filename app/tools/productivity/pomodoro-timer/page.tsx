...
import { toolConfig as config } from "@/tools/pomodoro-timer/config";

const PomodoroTimerUI = dynamic(() => import("@/tools/pomodoro-timer/ui"));

const canonicalUrl = `${siteConfig.url}/tools/productivity/pomodoro-timer`;
