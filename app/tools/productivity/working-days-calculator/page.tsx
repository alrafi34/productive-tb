...
import { toolConfig as config } from "@/tools/working-days-calculator/config";

const WorkingDaysCalculatorUI = dynamic(() => import("@/tools/working-days-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/productivity/working-days-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("working-days-calculator"),
