...
import { toolConfig as config } from "@/tools/timer-stopwatch/config";

const TimerStopwatchUI = dynamic(() => import("@/tools/timer-stopwatch/ui"));

const canonicalUrl = `${siteConfig.url}/tools/productivity/timer-stopwatch`;
