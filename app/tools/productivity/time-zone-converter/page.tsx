...
import { toolConfig as config } from "@/tools/time-zone-converter/config";

const TimeZoneConverterUI = dynamic(() => import("@/tools/time-zone-converter/ui"));

const canonicalUrl = `${siteConfig.url}/tools/productivity/time-zone-converter`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("time-zone-converter"),
