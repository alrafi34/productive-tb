...
import { toolConfig as config } from "@/tools/decision-wheel/config";

const DecisionWheelUI = dynamic(() => import("@/tools/decision-wheel/ui"));

const canonicalUrl = `${siteConfig.url}/tools/productivity/decision-wheel`;
