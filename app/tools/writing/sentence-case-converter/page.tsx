...
import { toolConfig as config } from "@/tools/sentence-case-converter/config";

const SentenceCaseConverterUI = dynamic(() => import("@/tools/sentence-case-converter/ui"));

const canonicalUrl = `${siteConfig.url}/tools/writing/sentence-case-converter`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("sentence-case-converter"),
