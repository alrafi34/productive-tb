...
import { textDiffCheckerConfig as config } from "@/tools/text-diff-checker/config";

const TextDiffCheckerUI = dynamic(() => import("@/tools/text-diff-checker/ui"));

const canonicalUrl = `${siteConfig.url}/tools/writing/text-diff-checker`;
