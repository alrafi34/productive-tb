...
import { toolConfig as config } from "@/tools/lorem-ipsum-generator/config";

const LoremIpsumGeneratorUI = dynamic(() => import("@/tools/lorem-ipsum-generator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/writing/lorem-ipsum-generator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("lorem-ipsum-generator"),
