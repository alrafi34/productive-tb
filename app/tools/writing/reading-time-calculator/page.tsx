...
import { toolConfig as config } from "@/tools/reading-time-calculator/config";

const ReadingTimeCalculatorUI = dynamic(() => import("@/tools/reading-time-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/writing/reading-time-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("reading-time-calculator"),
