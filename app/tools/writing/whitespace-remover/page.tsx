...
import { whitespaceRemoverConfig as config } from "@/tools/whitespace-remover/config";

const WhitespaceRemoverUI = dynamic(() => import("@/tools/whitespace-remover/ui"));

const canonicalUrl = `${siteConfig.url}/tools/writing/whitespace-remover`;
