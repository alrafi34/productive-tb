...
import { findAndReplaceConfig as config } from "@/tools/find-and-replace/config";

const FindAndReplaceUI = dynamic(() => import("@/tools/find-and-replace/ui"));

const canonicalUrl = `${siteConfig.url}/tools/writing/find-and-replace`;
