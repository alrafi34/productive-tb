...
import { randomNamePickerConfig as config } from "@/tools/random-name-picker/config";

const RandomNamePickerUI = dynamic(() => import("@/tools/random-name-picker/ui"));

const canonicalUrl = `${siteConfig.url}/tools/writing/random-name-picker`;
