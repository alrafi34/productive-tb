...
const canonicalUrl = `${siteConfig.url}/tools/writing/remove-duplicate-lines`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("remove-duplicate-lines"),
