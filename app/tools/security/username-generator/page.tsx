...
import { usernameGeneratorConfig as config } from "@/tools/username-generator/config";

const UsernameGeneratorUI = dynamic(() => import("@/tools/username-generator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/security/username-generator`;
