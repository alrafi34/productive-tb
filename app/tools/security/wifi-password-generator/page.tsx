...
import { wifiPasswordGeneratorConfig as config } from "@/tools/wifi-password-generator/config";

const WiFiPasswordGeneratorUI = dynamic(() => import("@/tools/wifi-password-generator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/security/wifi-password-generator`;

const seo = (config as any).seo ?? {};
const toolName = (config as any).name ?? (config as any).title ?? "wifi-password-generator";
...
export const metadata: Metadata = {
  ...
  ...toolRobots("wifi-password-generator"),
...
export default function WiFiPasswordGeneratorPage() {
  const catObj = categories.find((c) => c.slug === "security");
