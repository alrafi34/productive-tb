...
import { passwordStrengthMeterConfig as config } from "@/tools/password-strength-meter/config";

const PasswordStrengthMeterUI = dynamic(() => import("@/tools/password-strength-meter/ui"));

const canonicalUrl = `${siteConfig.url}/tools/security/password-strength-meter`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("password-strength-meter"),
