...
import { passwordGeneratorConfig as config } from "@/tools/password-generator/config";

const PasswordGeneratorUI = dynamic(() => import("@/tools/password-generator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/security/password-generator`;
