...
import { toolConfig as config } from "@/tools/salary-calculator/config";

const SalaryCalculatorUI = dynamic(() => import("@/tools/salary-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/calculator/salary-calculator`;
