...
import { kgToPoundConverterConfig as config } from "@/tools/kg-to-pound-converter/config";

const KgToPoundConverterUI = dynamic(() => import("@/tools/kg-to-pound-converter/ui"));

const canonicalUrl = `${siteConfig.url}/tools/calculator/kg-to-pound-converter`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("kg-to-pound-converter"),
