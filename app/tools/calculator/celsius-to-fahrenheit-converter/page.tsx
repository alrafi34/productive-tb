...
import { celsiusToFahrenheitConverterConfig as config } from "@/tools/celsius-to-fahrenheit-converter/config";

const CelsiusToFahrenheitConverterUI = dynamic(() => import("@/tools/celsius-to-fahrenheit-converter/ui"));

const canonicalUrl = `${siteConfig.url}/tools/calculator/celsius-to-fahrenheit-converter`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("celsius-to-fahrenheit-converter"),
  ...
  return (
    <>
      ...
      <ToolLayout
        ...
        category={catObj}
      >
        <CelsiusToFahrenheitConverterUI />
      </ToolLayout>
    </>
  );
}
