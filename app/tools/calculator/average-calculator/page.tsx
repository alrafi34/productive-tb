...
import { averageCalculatorConfig as config } from "@/tools/average-calculator/config";

const AverageCalculatorUI = dynamic(() => import("@/tools/average-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/calculator/average-calculator`;
