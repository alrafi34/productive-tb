...
import { toolConfig as config } from "@/tools/percentage-increase-decrease-calculator/config";

const PercentageIncreaseDecreaseUI = dynamic(() => import("@/tools/percentage-increase-decrease-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/calculator/percentage-increase-decrease`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("percentage-increase-decrease"),
...
export default function PercentageIncreaseDecreasePage() {
