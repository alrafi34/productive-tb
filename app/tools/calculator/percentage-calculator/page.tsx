...
import { toolConfig as config } from "@/tools/percentage-calculator/config";

const PercentageCalculatorUI = dynamic(() => import("@/tools/percentage-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/calculator/percentage-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("percentage-calculator"),
