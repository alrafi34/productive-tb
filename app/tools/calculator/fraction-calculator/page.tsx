...
import { fractionCalculatorConfig as config } from "@/tools/fraction-calculator/config";

const FractionCalculatorUI = dynamic(() => import("@/tools/fraction-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/calculator/fraction-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("fraction-calculator"),
