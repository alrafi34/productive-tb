...
import { toolConfig as config } from "@/tools/date-difference-calculator/config";

const DateDifferenceCalculatorUI = dynamic(() => import("@/tools/date-difference-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/calculator/date-difference-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("date-difference-calculator"),
