...
import { toolConfig as config } from "@/tools/gst-vat-calculator/config";

const GstVatCalculatorUI = dynamic(() => import("@/tools/gst-vat-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/calculator/gst-vat-calculator`;
