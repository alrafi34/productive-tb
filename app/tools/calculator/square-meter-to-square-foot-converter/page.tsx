...
import { toolConfig as config } from "@/tools/square-meter-to-square-foot-converter/config";

const SquareMeterToSquareFootConverterUI = dynamic(() => import("@/tools/square-meter-to-square-foot-converter/ui"));

const canonicalUrl = `${siteConfig.url}/tools/calculator/square-meter-to-square-foot-converter`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("square-meter-to-square-foot-converter"),
...
export default function SquareMeterToSquareFootConverterPage() {
  ...
  return (
    <>
      ...
      <ToolLayout
        ...
        category={catObj}
      >
        <SquareMeterToSquareFootConverterUI />
      </ToolLayout>
    </>
  );
}
