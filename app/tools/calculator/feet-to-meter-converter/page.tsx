...
import { feetToMeterConverterConfig as config } from "@/tools/feet-to-meter-converter/config";

const FeetToMeterConverterUI = dynamic(() => import("@/tools/feet-to-meter-converter/ui"));

const canonicalUrl = `${siteConfig.url}/tools/calculator/feet-to-meter-converter`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("feet-to-meter-converter"),
...
export default function FeetToMeterConverterPage() {
