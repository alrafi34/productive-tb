...
import { toolConfig as config } from "@/tools/ideal-weight-calculator/config";

const IdealWeightCalculatorUI = dynamic(() => import("@/tools/ideal-weight-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/calculator/ideal-weight-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("ideal-weight-calculator"),
