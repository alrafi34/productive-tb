...
import { literToMlConverterConfig as config } from "@/tools/liter-to-ml-converter/config";

const LiterToMlConverterUI = dynamic(() => import("@/tools/liter-to-ml-converter/ui"));

const canonicalUrl = `${siteConfig.url}/tools/calculator/liter-to-ml-converter`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("liter-to-ml-converter"),
...
export default function LiterToMlConverterPage() {
