...
import { toolConfig as config } from "@/tools/compound-interest-calculator/config";

const CompoundInterestCalculatorUI = dynamic(() => import("@/tools/compound-interest-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/calculator/compound-interest-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("compound-interest-calculator"),
