...
import { toolConfig as config } from "@/tools/simple-interest-calculator/config";

const SimpleInterestCalculatorUI = dynamic(() => import("@/tools/simple-interest-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/calculator/simple-interest-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("simple-interest-calculator"),
