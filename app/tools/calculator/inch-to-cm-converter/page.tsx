...
import { toolConfig as config } from "@/tools/inch-to-cm-converter/config";

const InchToCmConverterUI = dynamic(() => import("@/tools/inch-to-cm-converter/ui"));

const canonicalUrl = `${siteConfig.url}/tools/calculator/inch-to-cm-converter`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("inch-to-cm-converter"),
...
export default function InchToCmConverterPage() {
