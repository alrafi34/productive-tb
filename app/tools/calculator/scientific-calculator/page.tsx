...
import { scientificCalculatorConfig as config } from "@/tools/scientific-calculator/config";

const ScientificCalculatorUI = dynamic(() => import("@/tools/scientific-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/calculator/scientific-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("scientific-calculator"),
