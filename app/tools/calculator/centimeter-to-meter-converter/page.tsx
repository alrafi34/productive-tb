...
import { toolConfig as config } from "@/tools/centimeter-to-meter-converter/config";

const CentimeterToMeterConverterUI = dynamic(() => import("@/tools/centimeter-to-meter-converter/ui"));

const canonicalUrl = `${siteConfig.url}/tools/calculator/centimeter-to-meter-converter`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("centimeter-to-meter-converter"),
...
export default function CentimeterToMeterConverterPage() {
  ...
  return (
    <>
      ...
      <ToolLayout
        slug="centimeter-to-meter-converter"
        title={toolName}
        description={toolDescription}
        icon={(config as any).icon}
        category={catObj}
      >
        <CentimeterToMeterConverterUI />
      </ToolLayout>
    </>
  );
}
