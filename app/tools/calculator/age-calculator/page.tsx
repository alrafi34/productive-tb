...
import { toolConfig as config } from "@/tools/age-calculator/config";

const AgeCalculatorUI = dynamic(() => import("@/tools/age-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/calculator/age-calculator`;
