...
import { toolConfig as config } from "@/tools/investment-return-calculator/config";

const InvestmentReturnCalculatorUI = dynamic(() => import("@/tools/investment-return-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/calculator/investment-return-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("investment-return-calculator"),
