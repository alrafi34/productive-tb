...
import { toolConfig as config } from "@/tools/fuel-cost-calculator/config";

const FuelCostCalculatorUI = dynamic(() => import("@/tools/fuel-cost-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/calculator/fuel-cost-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("fuel-cost-calculator"),
