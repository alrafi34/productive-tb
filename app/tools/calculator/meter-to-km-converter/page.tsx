...
import { toolConfig as config } from "@/tools/meter-to-km-converter/config";

const MeterToKmConverterUI = dynamic(() => import("@/tools/meter-to-km-converter/ui"));

const canonicalUrl = `${siteConfig.url}/tools/calculator/meter-to-km-converter`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("meter-to-km-converter"),
...
export default function MeterToKmConverterPage() {
