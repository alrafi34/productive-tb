...
import { toolConfig as config } from "@/tools/discount-calculator/config";

const DiscountCalculatorUI = dynamic(() => import("@/tools/discount-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/calculator/discount-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("discount-calculator"),
