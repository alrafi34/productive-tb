...
import { toolConfig as config } from "@/tools/daily-calorie-calculator/config";

const DailyCalorieCalculatorUI = dynamic(() => import("@/tools/daily-calorie-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/calculator/daily-calorie-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("daily-calorie-calculator"),
...
export default function DailyCalorieCalculatorPage() {
