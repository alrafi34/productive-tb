...
import { toolConfig as config } from "@/tools/body-fat-calculator/config";

const BodyFatCalculatorUI = dynamic(() => import("@/tools/body-fat-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/calculator/body-fat-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("body-fat-calculator"),
