...
import { gramToOunceConverterConfig as config } from "@/tools/gram-to-ounce-converter/config";

const GramToOunceConverterUI = dynamic(() => import("@/tools/gram-to-ounce-converter/ui"));

const canonicalUrl = `${siteConfig.url}/tools/calculator/gram-to-ounce-converter`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("gram-to-ounce-converter"),
...
export default function GramToOunceConverterPage() {
