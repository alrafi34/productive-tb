...
import { toolConfig as config } from "@/tools/bmi-calculator/config";

const BmiCalculatorUI = dynamic(() => import("@/tools/bmi-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/calculator/bmi-calculator`;
