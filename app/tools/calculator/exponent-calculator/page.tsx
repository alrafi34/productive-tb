...
import { toolConfig as config } from "@/tools/exponent-calculator/config";

const ExponentCalculatorUI = dynamic(() => import("@/tools/exponent-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/calculator/exponent-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("exponent-calculator"),
