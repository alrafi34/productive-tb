...
import { subdivisionCostCalculatorConfig as config } from "@/tools/subdivision-cost-calculator/config";

const SubdivisionCostCalculatorUI = dynamic(() => import("@/tools/subdivision-cost-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/land/subdivision-cost-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("subdivision-cost-calculator"),
