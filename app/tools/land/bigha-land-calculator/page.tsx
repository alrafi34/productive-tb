...
import { bighaLandCalculatorConfig as config } from "@/tools/bigha-land-calculator/config";

const BighaLandCalculatorUI = dynamic(() => import("@/tools/bigha-land-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/land/bigha-land-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("bigha-land-calculator"),
