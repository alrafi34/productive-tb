...
import { plotDivisionCalculatorConfig as config } from "@/tools/plot-division-calculator/config";

const PlotDivisionCalculatorUI = dynamic(() => import("@/tools/plot-division-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/land/plot-division-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("plot-division-calculator"),
