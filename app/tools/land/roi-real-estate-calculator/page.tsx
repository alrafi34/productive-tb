...
import { roiRealEstateCalculatorConfig as config } from "@/tools/roi-real-estate-calculator/config";

const RoiRealEstateCalculatorUI = dynamic(() => import("@/tools/roi-real-estate-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/land/roi-real-estate-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("roi-real-estate-calculator"),
