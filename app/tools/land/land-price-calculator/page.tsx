...
import { landPriceCalculatorConfig as config } from "@/tools/land-price-calculator/config";

const LandPriceCalculatorUI = dynamic(() => import("@/tools/land-price-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/land/land-price-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("land-price-calculator"),
