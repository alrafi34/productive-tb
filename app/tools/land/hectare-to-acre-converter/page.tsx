...
import { hectareToAcreConverterConfig as config } from "@/tools/hectare-to-acre-converter/config";

const HectareToAcreConverterUI = dynamic(() => import("@/tools/hectare-to-acre-converter/ui"));

const canonicalUrl = `${siteConfig.url}/tools/land/hectare-to-acre-converter`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("hectare-to-acre-converter"),
