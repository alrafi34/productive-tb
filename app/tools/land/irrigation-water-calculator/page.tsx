...
import { irrigationWaterCalculatorConfig as config } from "@/tools/irrigation-water-calculator/config";

const IrrigationWaterCalculatorUI = dynamic(() => import("@/tools/irrigation-water-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/land/irrigation-water-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("irrigation-water-calculator"),
