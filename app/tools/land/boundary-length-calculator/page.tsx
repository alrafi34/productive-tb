...
import { boundaryLengthCalculatorConfig as config } from "@/tools/boundary-length-calculator/config";

const BoundaryLengthCalculatorUI = dynamic(() => import("@/tools/boundary-length-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/land/boundary-length-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("boundary-length-calculator"),
