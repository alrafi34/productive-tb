...
import { acreToSquareFeetConverterConfig as config } from "@/tools/acre-to-square-feet-converter/config";

const AcreToSquareFeetConverterUI = dynamic(() => import("@/tools/acre-to-square-feet-converter/ui"));

const canonicalUrl = `${siteConfig.url}/tools/land/acre-to-square-feet-converter`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("acre-to-square-feet-converter"),
