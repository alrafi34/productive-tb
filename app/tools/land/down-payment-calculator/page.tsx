...
import { downPaymentCalculatorConfig as config } from "@/tools/down-payment-calculator/config";

const DownPaymentCalculatorUI = dynamic(() => import("@/tools/down-payment-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/land/down-payment-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("down-payment-calculator"),
