...
import { decimalLandCalculatorConfig as config } from "@/tools/decimal-land-calculator/config";

const DecimalLandCalculatorUI = dynamic(() => import("@/tools/decimal-land-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/land/decimal-land-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("decimal-land-calculator"),
