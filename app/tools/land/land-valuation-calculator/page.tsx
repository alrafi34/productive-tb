...
import { landValuationCalculatorConfig as config } from "@/tools/land-valuation-calculator/config";

const LandValuationCalculatorUI = dynamic(() => import("@/tools/land-valuation-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/land/land-valuation-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("land-valuation-calculator"),
