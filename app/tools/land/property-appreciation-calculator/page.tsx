...
import { propertyAppreciationCalculatorConfig as config } from "@/tools/property-appreciation-calculator/config";

const PropertyAppreciationCalculatorUI = dynamic(() => import("@/tools/property-appreciation-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/land/property-appreciation-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("property-appreciation-calculator"),
