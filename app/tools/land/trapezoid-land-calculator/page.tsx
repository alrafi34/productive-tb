...
import { trapezoidLandCalculatorConfig as config } from "@/tools/trapezoid-land-calculator/config";

const TrapezoidLandCalculatorUI = dynamic(() => import("@/tools/trapezoid-land-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/land/trapezoid-land-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("trapezoid-land-calculator"),
