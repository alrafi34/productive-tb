...
import { rainwaterRunoffCalculatorConfig as config } from "@/tools/rainwater-runoff-calculator/config";

const RainwaterRunoffCalculatorUI = dynamic(() => import("@/tools/rainwater-runoff-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/land/rainwater-runoff-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("rainwater-runoff-calculator"),
