...
import { mapScaleCalculatorConfig as config } from "@/tools/map-scale-calculator/config";

const MapScaleCalculatorUI = dynamic(() => import("@/tools/map-scale-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/land/map-scale-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("map-scale-calculator"),
