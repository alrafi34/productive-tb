...
import { wallBoundaryCostCalculatorConfig as config } from "@/tools/wall-boundary-cost-calculator/config";

const WallBoundaryCostCalculatorUI = dynamic(() => import("@/tools/wall-boundary-cost-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/land/wall-boundary-cost-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("wall-boundary-cost-calculator"),
