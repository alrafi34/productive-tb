...
import { kathaLandCalculatorConfig as config } from "@/tools/katha-land-calculator/config";

const KathaLandCalculatorUI = dynamic(() => import("@/tools/katha-land-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/land/katha-land-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("katha-land-calculator"),
