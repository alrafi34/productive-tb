...
import { pricePerSquareFeetCalculatorConfig as config } from "@/tools/price-per-square-feet-calculator/config";

const PricePerSquareFeetCalculatorUI = dynamic(() => import("@/tools/price-per-square-feet-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/land/price-per-square-feet-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("price-per-square-feet-calculator"),
