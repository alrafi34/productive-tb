...
import { polygonAreaCalculatorConfig as config } from "@/tools/polygon-area-calculator/config";

const PolygonAreaCalculatorUI = dynamic(() => import("@/tools/polygon-area-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/land/polygon-area-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("polygon-area-calculator"),
