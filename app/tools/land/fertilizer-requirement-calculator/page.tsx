...
import { fertilizerRequirementCalculatorConfig as config } from "@/tools/fertilizer-requirement-calculator/config";

const FertilizerRequirementCalculatorUI = dynamic(() => import("@/tools/fertilizer-requirement-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/land/fertilizer-requirement-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("fertilizer-requirement-calculator"),
