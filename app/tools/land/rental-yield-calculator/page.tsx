...
import { rentalYieldCalculatorConfig as config } from "@/tools/rental-yield-calculator/config";

const RentalYieldCalculatorUI = dynamic(() => import("@/tools/rental-yield-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/land/rental-yield-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("rental-yield-calculator"),
