...
import { landLevelingCalculatorConfig as config } from "@/tools/land-leveling-calculator/config";

const LandLevelingCalculatorUI = dynamic(() => import("@/tools/land-leveling-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/land/land-leveling-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("land-leveling-calculator"),
