...
import { drainageSystemCalculatorConfig as config } from "@/tools/drainage-system-calculator/config";

const DrainageSystemCalculatorUI = dynamic(() => import("@/tools/drainage-system-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/land/drainage-system-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("drainage-system-calculator"),
