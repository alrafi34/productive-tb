...
import { squareFeetToAcreConverterConfig as config } from "@/tools/square-feet-to-acre-converter/config";

const SquareFeetToAcreConverterUI = dynamic(() => import("@/tools/square-feet-to-acre-converter/ui"));

const canonicalUrl = `${siteConfig.url}/tools/land/square-feet-to-acre-converter`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("square-feet-to-acre-converter"),
