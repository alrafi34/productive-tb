...
import { excavationCostCalculatorConfig as config } from "@/tools/excavation-cost-calculator/config";

const ExcavationCostCalculatorUI = dynamic(() => import("@/tools/excavation-cost-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/land/excavation-cost-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("excavation-cost-calculator"),
