...
import { fenceMaterialCalculatorConfig as config } from "@/tools/fence-material-calculator/config";

const FenceMaterialCalculatorUI = dynamic(() => import("@/tools/fence-material-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/land/fence-material-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("fence-material-calculator"),
