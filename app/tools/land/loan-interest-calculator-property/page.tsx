...
import { loanInterestCalculatorPropertyConfig as config } from "@/tools/loan-interest-calculator-property/config";

const LoanInterestCalculatorPropertyUI = dynamic(() => import("@/tools/loan-interest-calculator-property/ui"));

const canonicalUrl = `${siteConfig.url}/tools/land/loan-interest-calculator-property`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("loan-interest-calculator-property"),
