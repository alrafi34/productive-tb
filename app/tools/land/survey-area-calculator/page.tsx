...
import { surveyAreaCalculatorConfig as config } from "@/tools/survey-area-calculator/config";

const SurveyAreaCalculatorUI = dynamic(() => import("@/tools/survey-area-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/land/survey-area-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("survey-area-calculator"),
