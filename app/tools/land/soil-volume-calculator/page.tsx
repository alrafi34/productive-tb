...
import { soilVolumeCalculatorConfig as config } from "@/tools/soil-volume-calculator/config";

const SoilVolumeCalculatorUI = dynamic(() => import("@/tools/soil-volume-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/land/soil-volume-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("soil-volume-calculator"),
