...
import { soilCompactionRatioCalculatorConfig as config } from "@/tools/soil-compaction-ratio-calculator/config";

const SoilCompactionRatioCalculatorUI = dynamic(() => import("@/tools/soil-compaction-ratio-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/land/soil-compaction-ratio-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("soil-compaction-ratio-calculator"),
