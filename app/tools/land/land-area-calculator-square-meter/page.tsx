...
import { landAreaCalculatorSquareMeterConfig as config } from "@/tools/land-area-calculator-square-meter/config";

const LandAreaCalculatorSquareMeterUI = dynamic(() => import("@/tools/land-area-calculator-square-meter/ui"));

const canonicalUrl = `${siteConfig.url}/tools/land/land-area-calculator-square-meter`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("land-area-calculator-square-meter"),
