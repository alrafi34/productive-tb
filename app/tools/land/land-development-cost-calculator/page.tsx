...
import { landDevelopmentCostCalculatorConfig as config } from "@/tools/land-development-cost-calculator/config";

const LandDevelopmentCostCalculatorUI = dynamic(() => import("@/tools/land-development-cost-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/land/land-development-cost-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("land-development-cost-calculator"),
