...
import { earthFillingCalculatorConfig as config } from "@/tools/earth-filling-calculator/config";

const EarthFillingCalculatorUI = dynamic(() => import("@/tools/earth-filling-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/land/earth-filling-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("earth-filling-calculator"),
