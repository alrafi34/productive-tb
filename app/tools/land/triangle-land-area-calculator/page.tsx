...
import { triangleLandAreaCalculatorConfig as config } from "@/tools/triangle-land-area-calculator/config";

const TriangleLandAreaCalculatorUI = dynamic(() => import("@/tools/triangle-land-area-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/land/triangle-land-area-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("triangle-land-area-calculator"),
