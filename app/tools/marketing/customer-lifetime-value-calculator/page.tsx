...
const CLVCalculatorUI = dynamic(() => import("@/tools/customer-lifetime-value-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/marketing/customer-lifetime-value-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("customer-lifetime-value-calculator"),
