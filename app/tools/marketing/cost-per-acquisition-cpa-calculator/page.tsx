...
const CPACalculatorUI = dynamic(() => import("@/tools/cost-per-acquisition-cpa-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/marketing/cost-per-acquisition-cpa-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("cost-per-acquisition-cpa-calculator"),
...
export default function CostPerAcquisitionCpaCalculatorPage() {
