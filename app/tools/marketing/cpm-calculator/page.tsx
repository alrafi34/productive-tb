...
import { cpmCalculatorConfig as config } from "@/tools/cpm-calculator/config";

const CPMCalculatorUI = dynamic(() => import("@/tools/cpm-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/marketing/cpm-calculator`;
