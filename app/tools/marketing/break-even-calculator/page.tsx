...
const BreakEvenCalculatorUI = dynamic(() => import("@/tools/break-even-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/marketing/break-even-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("break-even-calculator"),
