...
const RevenueGrowthCalculatorUI = dynamic(() => import("@/tools/revenue-growth-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/marketing/revenue-growth-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("revenue-growth-calculator"),
