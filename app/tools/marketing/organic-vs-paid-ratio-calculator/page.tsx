...
const OrganicVsPaidRatioCalculatorUI = dynamic(() => import("@/tools/organic-vs-paid-ratio-calculator/ui"));
...
export const metadata: Metadata = {
  ...
  ...toolRobots("organic-vs-paid-ratio-calculator"),
...
export default function OrganicVsPaidRatioCalculatorPage() {
  ...
  return (
    <>
      ...
      <ToolLayout
        slug="organic-vs-paid-ratio-calculator"
        title={toolName}
        description={toolDescription}
