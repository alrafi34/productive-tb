...
const ProfitMarginCalculatorUI = dynamic(() => import("@/tools/profit-margin-calculator-marketing/ui"));

const canonicalUrl = `${siteConfig.url}/tools/marketing/profit-margin-calculator-marketing`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("profit-margin-calculator-marketing"),
...
export default function ProfitMarginCalculatorMarketingPage() {
