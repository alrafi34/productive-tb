...
const SEOScoreCalculatorUI = dynamic(() => import("@/tools/seo-score-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/marketing/seo-score-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("seo-score-calculator"),
