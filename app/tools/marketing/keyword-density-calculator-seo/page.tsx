...
const KeywordDensityCalculatorUI = dynamic(() => import("@/tools/keyword-density-calculator-seo/ui"));

const canonicalUrl = `${siteConfig.url}/tools/marketing/keyword-density-calculator-seo`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("keyword-density-calculator-seo"),
...
export default function KeywordDensityCalculatorSeoPage() {
