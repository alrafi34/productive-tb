...
import { rlcResonanceCalculatorConfig as config } from "@/tools/rlc-resonance-calculator/config";

const RLCResonanceCalculatorUI = dynamic(() => import("@/tools/rlc-resonance-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/rlc-resonance-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("rlc-resonance-calculator"),
