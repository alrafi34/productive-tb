...
import { smpsCalculatorConfig as config } from "@/tools/smps-calculator/config";

const SMPSCalculatorUI = dynamic(() => import("@/tools/smps-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/smps-calculator`;
