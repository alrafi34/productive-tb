...
import { energyConsumptionCalculatorConfig as config } from "@/tools/energy-consumption-calculator/config";

const EnergyConsumptionCalculatorUI = dynamic(() => import("@/tools/energy-consumption-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/energy-consumption-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("energy-consumption-calculator"),
