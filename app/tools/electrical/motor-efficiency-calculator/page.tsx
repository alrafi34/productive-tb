...
import { motorEfficiencyCalculatorConfig as config } from "@/tools/motor-efficiency-calculator/config";

const MotorEfficiencyCalculatorUI = dynamic(() => import("@/tools/motor-efficiency-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/motor-efficiency-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("motor-efficiency-calculator"),
