...
import { dataRateCalculatorConfig as config } from "@/tools/data-rate-calculator/config";

const DataRateCalculatorUI = dynamic(() => import("@/tools/data-rate-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/data-rate-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("data-rate-calculator"),
