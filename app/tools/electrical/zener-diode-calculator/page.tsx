...
import { toolConfig as config } from "@/tools/zener-diode-calculator/config";

const ZenerDiodeCalculatorUI = dynamic(() => import("@/tools/zener-diode-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/zener-diode-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("zener-diode-calculator"),
