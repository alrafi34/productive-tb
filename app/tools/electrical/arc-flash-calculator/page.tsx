...
import { arcFlashCalculatorConfig as config } from "@/tools/arc-flash-calculator/config";

const ArcFlashCalculatorUI = dynamic(() => import("@/tools/arc-flash-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/arc-flash-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("arc-flash-calculator"),
