...
import { reactivePowerCalculatorConfig as config } from "@/tools/reactive-power-calculator/config";

const ReactivePowerCalculatorUI = dynamic(() => import("@/tools/reactive-power-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/reactive-power-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("reactive-power-calculator"),
