...
import { capacitorChargeTimeCalculatorConfig as config } from "@/tools/capacitor-charge-time-calculator/config";

const CapacitorChargeTimeCalculatorUI = dynamic(() => import("@/tools/capacitor-charge-time-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/capacitor-charge-time-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("capacitor-charge-time-calculator"),
