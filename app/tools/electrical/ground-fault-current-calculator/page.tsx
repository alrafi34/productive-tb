...
import { groundFaultCurrentCalculatorConfig as config } from "@/tools/ground-fault-current-calculator/config";

const GroundFaultCurrentCalculatorUI = dynamic(() => import("@/tools/ground-fault-current-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/ground-fault-current-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("ground-fault-current-calculator"),
