...
import { rcTimeConstantCalculatorConfig as config } from "@/tools/rc-time-constant-calculator/config";

const RCTimeConstantCalculatorUI = dynamic(() => import("@/tools/rc-time-constant-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/rc-time-constant-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("rc-time-constant-calculator"),
