...
import { solarBatteryCalculatorConfig as config } from "@/tools/solar-battery-calculator/config";

const SolarBatteryCalculatorUI = dynamic(() => import("@/tools/solar-battery-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/solar-battery-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("solar-battery-calculator"),
