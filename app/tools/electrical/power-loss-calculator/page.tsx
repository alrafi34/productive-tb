...
import { powerLossCalculatorConfig as config } from "@/tools/power-loss-calculator/config";

const PowerLossCalculatorUI = dynamic(() => import("@/tools/power-loss-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/power-loss-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("power-loss-calculator"),
