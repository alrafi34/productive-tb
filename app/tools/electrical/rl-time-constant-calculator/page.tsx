...
import { rlTimeConstantCalculatorConfig as config } from "@/tools/rl-time-constant-calculator/config";

const RLTimeConstantCalculatorUI = dynamic(() => import("@/tools/rl-time-constant-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/rl-time-constant-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("rl-time-constant-calculator"),
