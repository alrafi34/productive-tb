...
import { decimalToBinaryCalculatorConfig as config } from "@/tools/decimal-to-binary-calculator/config";

const DecimalToBinaryCalculatorUI = dynamic(() => import("@/tools/decimal-to-binary-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/decimal-to-binary-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("decimal-to-binary-calculator"),
