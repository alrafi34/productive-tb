...
import { electricalEfficiencyCalculatorConfig as config } from "@/tools/electrical-efficiency-calculator/config";

const ElectricalEfficiencyCalculatorUI = dynamic(() => import("@/tools/electrical-efficiency-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/electrical-efficiency-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("electrical-efficiency-calculator"),
