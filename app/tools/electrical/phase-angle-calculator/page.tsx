...
import { toolConfig as config } from "@/tools/phase-angle-calculator/config";

const PhaseAngleCalculatorUI = dynamic(() => import("@/tools/phase-angle-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/phase-angle-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("phase-angle-calculator"),
