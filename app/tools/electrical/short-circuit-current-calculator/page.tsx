...
import { shortCircuitCurrentCalculatorConfig as config } from "@/tools/short-circuit-current-calculator/config";

const ShortCircuitCurrentCalculatorUI = dynamic(() => import("@/tools/short-circuit-current-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/short-circuit-current-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("short-circuit-current-calculator"),
