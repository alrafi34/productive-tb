...
import { toolConfig as config } from "@/tools/transistor-bias-calculator/config";

const TransistorBiasCalculatorUI = dynamic(() => import("@/tools/transistor-bias-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/transistor-bias-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("transistor-bias-calculator"),
