...
import { inductorCalculatorConfig as config } from "@/tools/inductor-calculator/config";

const InductorCalculatorUI = dynamic(() => import("@/tools/inductor-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/inductor-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("inductor-calculator"),
