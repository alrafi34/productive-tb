...
import { apparentPowerCalculatorConfig as config } from "@/tools/apparent-power-calculator/config";

const ApparentPowerCalculatorUI = dynamic(() => import("@/tools/apparent-power-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/apparent-power-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("apparent-power-calculator"),
