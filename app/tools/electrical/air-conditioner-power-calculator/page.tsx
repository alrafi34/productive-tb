...
import { airConditionerPowerCalculatorConfig as config } from "@/tools/air-conditioner-power-calculator/config";

const AirConditionerPowerCalculatorUI = dynamic(() => import("@/tools/air-conditioner-power-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/air-conditioner-power-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("air-conditioner-power-calculator"),
