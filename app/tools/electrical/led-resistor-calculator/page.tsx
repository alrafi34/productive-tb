...
import { toolConfig as config } from "@/tools/led-resistor-calculator/config";

const LEDResistorCalculatorUI = dynamic(() => import("@/tools/led-resistor-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/led-resistor-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("led-resistor-calculator"),
