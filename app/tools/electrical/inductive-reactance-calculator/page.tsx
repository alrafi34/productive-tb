...
import { inductiveReactanceCalculatorConfig as config } from "@/tools/inductive-reactance-calculator/config";

const InductiveReactanceCalculatorUI = dynamic(() => import("@/tools/inductive-reactance-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/inductive-reactance-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("inductive-reactance-calculator"),
