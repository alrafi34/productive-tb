...
import { circuitBreakerCalculatorConfig as config } from "@/tools/circuit-breaker-calculator/config";

const CircuitBreakerCalculatorUI = dynamic(() => import("@/tools/circuit-breaker-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/circuit-breaker-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("circuit-breaker-calculator"),
