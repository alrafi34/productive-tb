...
import { cableLengthCalculatorConfig as config } from "@/tools/cable-length-calculator/config";

const CableLengthCalculatorUI = dynamic(() => import("@/tools/cable-length-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/cable-length-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("cable-length-calculator"),
