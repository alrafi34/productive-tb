...
import { logicGateCalculatorConfig as config } from "@/tools/logic-gate-calculator/config";

const LogicGateCalculatorUI = dynamic(() => import("@/tools/logic-gate-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/logic-gate-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("logic-gate-calculator"),
