...
import { wireSizeCalculatorConfig as config } from "@/tools/wire-size-calculator/config";

const WireSizeCalculatorUI = dynamic(() => import("@/tools/wire-size-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/wire-size-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("wire-size-calculator"),
