...
import { voltageDividerCalculatorConfig as config } from "@/tools/voltage-divider-calculator/config";

const VoltageDividerCalculatorUI = dynamic(() => import("@/tools/voltage-divider-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/voltage-divider-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("voltage-divider-calculator"),
