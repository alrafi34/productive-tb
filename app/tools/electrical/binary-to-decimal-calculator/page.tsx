...
import { binaryToDecimalCalculatorConfig as config } from "@/tools/binary-to-decimal-calculator/config";

const BinaryToDecimalCalculatorUI = dynamic(() => import("@/tools/binary-to-decimal-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/binary-to-decimal-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("binary-to-decimal-calculator"),
