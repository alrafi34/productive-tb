...
import { solarPanelCalculatorConfig as config } from "@/tools/solar-panel-calculator/config";

const SolarPanelCalculatorUI = dynamic(() => import("@/tools/solar-panel-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/solar-panel-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("solar-panel-calculator"),
