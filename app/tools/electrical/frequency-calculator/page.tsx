...
import { frequencyCalculatorConfig as config } from "@/tools/frequency-calculator/config";

const FrequencyCalculatorUI = dynamic(() => import("@/tools/frequency-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/frequency-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("frequency-calculator"),
