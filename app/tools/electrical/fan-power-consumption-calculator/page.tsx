...
import { fanPowerConsumptionCalculatorConfig as config } from "@/tools/fan-power-consumption-calculator/config";

const FanPowerConsumptionCalculatorUI = dynamic(() => import("@/tools/fan-power-consumption-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/fan-power-consumption-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("fan-power-consumption-calculator"),
