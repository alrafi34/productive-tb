...
import { heatsinkCalculatorConfig as config } from "@/tools/heatsink-calculator/config";

const HeatsinkCalculatorUI = dynamic(() => import("@/tools/heatsink-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/heatsink-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("heatsink-calculator"),
