...
import { toolConfig as config } from "@/tools/transformer-current-calculator/config";

const TransformerCurrentCalculatorUI = dynamic(() => import("@/tools/transformer-current-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/transformer-current-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("transformer-current-calculator"),
