...
import { heatDissipationCalculatorConfig as config } from "@/tools/heat-dissipation-calculator/config";

const HeatDissipationCalculatorUI = dynamic(() => import("@/tools/heat-dissipation-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/heat-dissipation-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("heat-dissipation-calculator"),
