...
import { impedanceCalculatorConfig as config } from "@/tools/impedance-calculator/config";

const ImpedanceCalculatorUI = dynamic(() => import("@/tools/impedance-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/impedance-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("impedance-calculator"),
