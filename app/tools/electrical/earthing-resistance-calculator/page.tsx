...
import { earthingResistanceCalculatorConfig as config } from "@/tools/earthing-resistance-calculator/config";

const EarthingResistanceCalculatorUI = dynamic(() => import("@/tools/earthing-resistance-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/earthing-resistance-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("earthing-resistance-calculator"),
