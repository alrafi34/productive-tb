...
import { motorSpeedCalculatorConfig as config } from "@/tools/motor-speed-calculator/config";

const MotorSpeedCalculatorUI = dynamic(() => import("@/tools/motor-speed-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/motor-speed-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("motor-speed-calculator"),
