...
import { solarInverterCalculatorConfig as config } from "@/tools/solar-inverter-calculator/config";

const SolarInverterCalculatorUI = dynamic(() => import("@/tools/solar-inverter-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/solar-inverter-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("solar-inverter-calculator"),
