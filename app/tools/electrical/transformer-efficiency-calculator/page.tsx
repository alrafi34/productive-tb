...
import { toolConfig as config } from "@/tools/transformer-efficiency-calculator/config";

const TransformerEfficiencyCalculatorUI = dynamic(() => import("@/tools/transformer-efficiency-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/transformer-efficiency-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("transformer-efficiency-calculator"),
