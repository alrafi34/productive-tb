...
import { rfPowerCalculatorConfig as config } from "@/tools/rf-power-calculator/config";

const RFPowerCalculatorUI = dynamic(() => import("@/tools/rf-power-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/rf-power-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("rf-power-calculator"),
