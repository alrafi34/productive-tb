...
import { electricMotorPowerCalculatorConfig as config } from "@/tools/electric-motor-power-calculator/config";

const ElectricMotorPowerCalculatorUI = dynamic(() => import("@/tools/electric-motor-power-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/electric-motor-power-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("electric-motor-power-calculator"),
