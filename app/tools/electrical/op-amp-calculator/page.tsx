...
import { opAmpCalculatorConfig as config } from "@/tools/op-amp-calculator/config";

const OpAmpCalculatorUI = dynamic(() => import("@/tools/op-amp-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/op-amp-calculator`;
