...
import { wavelengthCalculatorConfig as config } from "@/tools/wavelength-calculator/config";

const WavelengthCalculatorUI = dynamic(() => import("@/tools/wavelength-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/wavelength-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("wavelength-calculator"),
