...
import { toolConfig as config } from "@/tools/battery-capacity-calculator/config";

const BatteryCapacityCalculatorUI = dynamic(() => import("@/tools/battery-capacity-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/battery-capacity-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("battery-capacity-calculator"),
