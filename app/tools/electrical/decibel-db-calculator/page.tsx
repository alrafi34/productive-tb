...
import { decibelCalculatorConfig as config } from "@/tools/decibel-db-calculator/config";

const DecibelCalculatorUI = dynamic(() => import("@/tools/decibel-db-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/decibel-db-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("decibel-db-calculator"),
...
export default function DecibelDbCalculatorPage() {
