...
import { dacOutputCalculatorConfig as config } from "@/tools/dac-output-calculator/config";

const DACOutputCalculatorUI = dynamic(() => import("@/tools/dac-output-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/dac-output-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("dac-output-calculator"),
