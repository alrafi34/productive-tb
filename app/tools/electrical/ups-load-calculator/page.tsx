...
import { upsLoadCalculatorConfig as config } from "@/tools/ups-load-calculator/config";

const UPSLoadCalculatorUI = dynamic(() => import("@/tools/ups-load-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/ups-load-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("ups-load-calculator"),
