...
import { lightningProtectionCalculatorConfig as config } from "@/tools/lightning-protection-calculator/config";

const LightningProtectionCalculatorUI = dynamic(() => import("@/tools/lightning-protection-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/lightning-protection-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("lightning-protection-calculator"),
