...
import { clockFrequencyCalculatorConfig as config } from "@/tools/clock-frequency-calculator/config";

const ClockFrequencyCalculatorUI = dynamic(() => import("@/tools/clock-frequency-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/clock-frequency-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("clock-frequency-calculator"),
