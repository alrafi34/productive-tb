...
import { realPowerCalculatorConfig as config } from "@/tools/real-power-calculator/config";

const RealPowerCalculatorUI = dynamic(() => import("@/tools/real-power-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/real-power-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("real-power-calculator"),
