...
import { fuseRatingCalculatorConfig as config } from "@/tools/fuse-rating-calculator/config";

const FuseRatingCalculatorUI = dynamic(() => import("@/tools/fuse-rating-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/fuse-rating-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("fuse-rating-calculator"),
