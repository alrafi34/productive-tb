...
import { powerSupplyCalculatorConfig as config } from "@/tools/power-supply-calculator/config";

const PowerSupplyCalculatorUI = dynamic(() => import("@/tools/power-supply-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/power-supply-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("power-supply-calculator"),
