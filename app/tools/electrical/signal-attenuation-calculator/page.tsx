...
import { signalAttenuationCalculatorConfig as config } from "@/tools/signal-attenuation-calculator/config";

const SignalAttenuationCalculatorUI = dynamic(() => import("@/tools/signal-attenuation-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/signal-attenuation-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("signal-attenuation-calculator"),
