...
import { amplifierGainCalculatorConfig as config } from "@/tools/amplifier-gain-calculator/config";

const AmplifierGainCalculatorUI = dynamic(() => import("@/tools/amplifier-gain-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/amplifier-gain-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("amplifier-gain-calculator"),
