...
import { toolConfig as config } from "@/tools/battery-charging-time-calculator/config";

const BatteryChargingTimeCalculatorUI = dynamic(() => import("@/tools/battery-charging-time-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/battery-charging-time-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("battery-charging-time-calculator"),
