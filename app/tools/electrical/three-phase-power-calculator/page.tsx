...
import { toolConfig as config } from "@/tools/three-phase-power-calculator/config";

const ThreePhasePowerCalculatorUI = dynamic(() => import("@/tools/three-phase-power-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/three-phase-power-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("three-phase-power-calculator"),
