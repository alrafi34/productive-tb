...
import { pwmDutyCycleCalculatorConfig as config } from "@/tools/pwm-duty-cycle-calculator/config";

const PWMDutyCycleCalculatorUI = dynamic(() => import("@/tools/pwm-duty-cycle-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/pwm-duty-cycle-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("pwm-duty-cycle-calculator"),
