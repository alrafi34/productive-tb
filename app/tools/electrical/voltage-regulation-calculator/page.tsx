...
import { voltageRegulationCalculatorConfig as config } from "@/tools/voltage-regulation-calculator/config";

const VoltageRegulationCalculatorUI = dynamic(() => import("@/tools/voltage-regulation-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/voltage-regulation-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("voltage-regulation-calculator"),
