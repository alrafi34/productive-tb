...
import { frequencyResponseCalculatorConfig as config } from "@/tools/frequency-response-calculator/config";

const FrequencyResponseCalculatorUI = dynamic(() => import("@/tools/frequency-response-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/frequency-response-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("frequency-response-calculator"),
