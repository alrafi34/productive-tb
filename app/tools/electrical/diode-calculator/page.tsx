...
import { toolConfig as config } from "@/tools/diode-calculator/config";

const DiodeCalculatorUI = dynamic(() => import("@/tools/diode-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/diode-calculator`;
