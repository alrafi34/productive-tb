...
import { adcResolutionCalculatorConfig as config } from "@/tools/adc-resolution-calculator/config";

const ADCResolutionCalculatorUI = dynamic(() => import("@/tools/adc-resolution-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/adc-resolution-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("adc-resolution-calculator"),
