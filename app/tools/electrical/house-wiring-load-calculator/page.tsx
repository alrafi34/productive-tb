...
import { houseWiringLoadCalculatorConfig as config } from "@/tools/house-wiring-load-calculator/config";

const HouseWiringLoadCalculatorUI = dynamic(() => import("@/tools/house-wiring-load-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/house-wiring-load-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("house-wiring-load-calculator"),
