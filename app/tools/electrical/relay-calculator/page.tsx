...
import { relayCalculatorConfig as config } from "@/tools/relay-calculator/config";

const RelayCalculatorUI = dynamic(() => import("@/tools/relay-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/relay-calculator`;
