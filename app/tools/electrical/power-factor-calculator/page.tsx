...
import { toolConfig as config } from "@/tools/power-factor-calculator/config";

const PowerFactorCalculatorUI = dynamic(() => import("@/tools/power-factor-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/power-factor-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("power-factor-calculator"),
