...
import { seriesResistorCalculatorConfig as config } from "@/tools/series-resistor-calculator/config";

const SeriesResistorCalculatorUI = dynamic(() => import("@/tools/series-resistor-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/series-resistor-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("series-resistor-calculator"),
