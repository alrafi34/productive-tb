...
import { toolConfig as config } from "@/tools/transformer-turns-ratio-calculator/config";

const TransformerTurnsRatioCalculatorUI = dynamic(() => import("@/tools/transformer-turns-ratio-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/transformer-turns-ratio-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("transformer-turns-ratio-calculator"),
