...
import { upsBackupCalculatorConfig as config } from "@/tools/ups-backup-calculator/config";

const UPSBackupCalculatorUI = dynamic(() => import("@/tools/ups-backup-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/ups-backup-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("ups-backup-calculator"),
