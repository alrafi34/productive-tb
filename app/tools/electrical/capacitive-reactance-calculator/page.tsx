...
import { capacitiveReactanceCalculatorConfig as config } from "@/tools/capacitive-reactance-calculator/config";

const CapacitiveReactanceCalculatorUI = dynamic(() => import("@/tools/capacitive-reactance-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/capacitive-reactance-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("capacitive-reactance-calculator"),
