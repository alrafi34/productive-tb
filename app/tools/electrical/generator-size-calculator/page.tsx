...
import { generatorSizeCalculatorConfig as config } from "@/tools/generator-size-calculator/config";

const GeneratorSizeCalculatorUI = dynamic(() => import("@/tools/generator-size-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/generator-size-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("generator-size-calculator"),
