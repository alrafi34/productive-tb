...
import { roomLightingCalculatorConfig as config } from "@/tools/room-lighting-calculator/config";

const RoomLightingCalculatorUI = dynamic(() => import("@/tools/room-lighting-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/room-lighting-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("room-lighting-calculator"),
