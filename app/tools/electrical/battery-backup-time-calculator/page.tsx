...
import { toolConfig as config } from "@/tools/battery-backup-time-calculator/config";

const BatteryBackupTimeCalculatorUI = dynamic(() => import("@/tools/battery-backup-time-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/battery-backup-time-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("battery-backup-time-calculator"),
