...
import { capacitorCalculatorConfig as config } from "@/tools/capacitor-calculator/config";

const CapacitorCalculatorUI = dynamic(() => import("@/tools/capacitor-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/capacitor-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("capacitor-calculator"),
