...
import { antennaLengthCalculatorConfig as config } from "@/tools/antenna-length-calculator/config";

const AntennaLengthCalculatorUI = dynamic(() => import("@/tools/antenna-length-calculator/ui"));

const canonicalUrl = `${siteConfig.url}/tools/electrical/antenna-length-calculator`;
...
export const metadata: Metadata = {
  ...
  ...toolRobots("antenna-length-calculator"),
